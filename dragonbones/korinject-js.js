(function (root, factory) {
  ...
  AsyncInjector.prototype.getSync_nw6hre$ = defineInlineFunction('korinject-js.com.soywiz.korinject.AsyncInjector.getSync_nw6hre$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
  ...
  function AsyncInjector$getSync$ObjectLiteral(closure$rresult, closure$rexception) {
  ...
  AsyncInjector$getSync$ObjectLiteral.prototype.resumeWith_i5d895$ = function (result) {
    if (result.isSuccess) {
      this.closure$rresult.v = result.getOrThrow();
    }
     else {
      this.closure$rexception.v = ensureNotNull(result.exceptionOrNull());
    }
  };
  ...
  AsyncInjector.prototype.getSync_wx4qjr$ = function (clazz, ctx) {
    ...
    startCoroutine(AsyncInjector$getSync$lambda(clazz, ctx, this), new AsyncInjector$getSync$ObjectLiteral(rresult, rexception));
