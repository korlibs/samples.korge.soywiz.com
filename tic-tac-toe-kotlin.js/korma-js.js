(function (root, factory) {
  ...
  var IMatrix2d_0 = defineInlineFunction('korma-js.com.soywiz.korma.IMatrix2d_9wz194$', wrapFunction(function () {
    ...
    return function (a, b, c, d, tx, ty) {
      return new Matrix2d$Matrix2d$Immutable_init(Kotlin.numberToDouble(a), Kotlin.numberToDouble(b), Kotlin.numberToDouble(c), Kotlin.numberToDouble(d), Kotlin.numberToDouble(tx), Kotlin.numberToDouble(ty));
    };
  }));
  ...
  function Matrix2d$Type$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.Matrix2d.Type.' + name);
    }
  }
  ...
  var Matrix2d_0 = defineInlineFunction('korma-js.com.soywiz.korma.Matrix2d_9wz194$', wrapFunction(function () {
    ...
    return function (a, b, c, d, tx, ty) {
      ...
      if (ty === void 0)
        ty = 0.0;
      return new Matrix2d_init(Kotlin.numberToDouble(a), Kotlin.numberToDouble(b), Kotlin.numberToDouble(c), Kotlin.numberToDouble(d), Kotlin.numberToDouble(tx), Kotlin.numberToDouble(ty));
    };
  }));
  ...
  var IVector2_0 = defineInlineFunction('korma-js.com.soywiz.korma.IVector2_z8e4lc$', wrapFunction(function () {
    ...
    return function (x, y) {
      return new Vector2$Vector2$Immutable_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y));
    };
  }));
  ...
  Vector2.prototype.setTo_z8e4lc$ = defineInlineFunction('korma-js.com.soywiz.korma.Vector2.setTo_z8e4lc$', function (x, y) {
    return this.setTo_lu1900$(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y));
  });
  ...
  var Vector2_0 = defineInlineFunction('korma-js.com.soywiz.korma.Vector2_z8e4lc$', wrapFunction(function () {
    ...
    return function (x, y) {
      return new Vector2_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y));
    };
  }));
  ...
  var Vector3_0 = defineInlineFunction('korma-js.com.soywiz.korma.Vector3_a2j3zq$', wrapFunction(function () {
    ...
    return function (x, y, z) {
      return new Vector3_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y), Kotlin.numberToDouble(z));
    };
  }));
  var IVector3_0 = defineInlineFunction('korma-js.com.soywiz.korma.IVector3_a2j3zq$', wrapFunction(function () {
    ...
    return function (x, y, z) {
      return new Vector3$Vector3$Immutable_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y), Kotlin.numberToDouble(z));
    };
  }));
  function AStar() {
    AStar_instance = this;
  ...
  AStar.prototype.find_m1zhmb$ = function (board, x0, y0, x1, y1, isBlocking, findClosest, diagonals) {
    ...
    if (findClosest || Kotlin.equals(closest, dest)) {
      var current = closest;
      while (current != null) {
  ...
  Array2$Companion.prototype.invoke_23h2vo$ = defineInlineFunction('korma-js.com.soywiz.korma.ds.Array2.Companion.invoke_23h2vo$', wrapFunction(function () {
    ...
    var Array2$Companion$invoke$lambda = wrapFunction(function () {
      ...
      return function (closure$marginChar) {
        return function (it) {
          var tmp$;
          var res = trim(Kotlin.isCharSequence(tmp$ = it) ? tmp$ : Kotlin.throwCCE()).toString();
    ...
    return function (T_0, isT, map, marginChar, gen) {
      ...
      while (tmp$_0.hasNext()) {
        ...
        var tmp$_2;
        var res = trim(Kotlin.isCharSequence(tmp$_2 = item) ? tmp$_2 : Kotlin.throwCCE()).toString();
  ...
  Array2.prototype.hashCode = function () {
    return this.width + this.height + Kotlin.hashCode(this.data) | 0;
  };
  ...
  Array2.prototype.getPositionsWithValue_11rb$ = function (value) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (Kotlin.equals(this.data[element], value))
  ...
  function BoundsBuilder() {
    ...
    this.xmin_0 = DoubleCompanionObject.MAX_VALUE;
    this.xmax_0 = DoubleCompanionObject.MIN_VALUE;
    this.ymin_0 = DoubleCompanionObject.MAX_VALUE;
    this.ymax_0 = DoubleCompanionObject.MIN_VALUE;
  }
  ...
  function Orientation$valueOf(name) {
    switch (name) {
      ...
      case 'COLLINEAR':
        return Orientation$COLLINEAR_getInstance();
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.Orientation.' + name);
    }
  }
  ...
  var IPoint2d = defineInlineFunction('korma-js.com.soywiz.korma.geom.IPoint2d_z8e4lc$', wrapFunction(function () {
    var Vector2$Vector2$Immutable_init = _.com.soywiz.korma.Vector2.Immutable;
    return function (x, y) {
      var x_0 = Kotlin.numberToDouble(x);
      var y_0 = Kotlin.numberToDouble(y);
      return new Vector2$Vector2$Immutable_init(Kotlin.numberToDouble(x_0), Kotlin.numberToDouble(y_0));
    };
  }));
  ...
  var PointInt_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.PointInt_z8e4lc$', wrapFunction(function () {
    ...
    return function (x, y) {
      return new PointInt_init(Kotlin.numberToInt(x), Kotlin.numberToInt(y));
    };
  }));
  var IPointInt_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.IPointInt_z8e4lc$', wrapFunction(function () {
    ...
    return function (x, y) {
      return new PointInt$PointInt$Immutable_init(Kotlin.numberToInt(x), Kotlin.numberToInt(y));
    };
  }));
  ...
  Rectangle.prototype.setTo_1ugm5o$ = defineInlineFunction('korma-js.com.soywiz.korma.geom.Rectangle.setTo_1ugm5o$', function (x, y, width, height) {
    return this.setTo_6y0v78$(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y), Kotlin.numberToDouble(width), Kotlin.numberToDouble(height));
  });
  ...
  Rectangle.prototype.setBounds_tjonv8$ = function (left, top, right, bottom) {
    ...
    return this.setTo_6y0v78$(Kotlin.numberToDouble(left), Kotlin.numberToDouble(top), Kotlin.numberToDouble(width), Kotlin.numberToDouble(height));
  };
  ...
  Rectangle.prototype.toInt = function () {
    ...
    var width = this.width;
    var height = this.height;
    return RectangleInt_init(Kotlin.numberToInt(x), Kotlin.numberToInt(y), Kotlin.numberToInt(width), Kotlin.numberToInt(height));
  };
  Rectangle.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
  ...
  var Rectangle_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.Rectangle_1ugm5o$', wrapFunction(function () {
    ...
    return function (x, y, width, height) {
      return new Rectangle_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y), Kotlin.numberToDouble(width), Kotlin.numberToDouble(height));
    };
  }));
  var IRectangle_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.IRectangle_1ugm5o$', wrapFunction(function () {
    ...
    return function (x, y, width, height) {
      return new Rectangle$Rectangle$Immutable_init(Kotlin.numberToDouble(x), Kotlin.numberToDouble(y), Kotlin.numberToDouble(width), Kotlin.numberToDouble(height));
    };
  }));
  ...
  RectangleInt.prototype.anchoredIn_t311vp$ = function (container, anchor, out) {
    ...
    return out.setTo_tjonv8$((container.width - this.width | 0) * anchor.sx | 0, (container.height - this.height | 0) * anchor.sy | 0, this.width, this.height);
  };
  RectangleInt.prototype.getAnchorPosition_ufk4ra$ = function (anchor, out) {
    if (out === void 0)
      out = new PointInt();
    return out.setTo_vux9f0$(this.x + this.width * anchor.sx | 0, this.y + this.height * anchor.sy | 0);
  };
  ...
  var IRectangleInt_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.IRectangleInt_1ugm5o$', wrapFunction(function () {
    ...
    return function (x, y, width, height) {
      return new RectangleInt$RectangleInt$Immutable_init(Kotlin.numberToInt(x), Kotlin.numberToInt(y), Kotlin.numberToInt(width), Kotlin.numberToInt(height));
    };
  }));
  ...
  Size.prototype.interpolateWith_e37ph5$ = function (other, ratio) {
    return (new Size(Kotlin.numberToDouble(0), Kotlin.numberToDouble(0))).setToInterpolated_v05y7o$(this, other, ratio);
  };
  ...
  var ISize_0 = defineInlineFunction('korma-js.com.soywiz.korma.geom.ISize_z8e4lc$', wrapFunction(function () {
    ...
    return function (width, height) {
      return new Size$Size$Immutable_init(Kotlin.numberToDouble(width), Kotlin.numberToDouble(height));
    };
  }));
  function Sizeable() {
  }
  ...
  SizeInt.prototype.times_14dthe$ = function (v) {
    return new SizeInt(this.width * v | 0, this.height * v | 0);
  };
  ...
  SizeInt.prototype.setToScaled_lu1900$ = function (sx, sy) {
    if (sy === void 0)
      sy = sx;
    return this.setTo_vux9f0$(this.width * sx | 0, this.height * sy | 0);
  };
  ...
  SizeInt.prototype.getAnchorPosition_ufk4ra$ = function (anchor, out) {
    if (out === void 0)
      out = new PointInt();
    return out.setTo_vux9f0$(this.width * anchor.sx | 0, this.height * anchor.sy | 0);
  };
  SizeInt.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: 'SizeInt',
  ...
  VectorPath.prototype.visit_b0d9tk$ = function (visitor) {
    var moveTo = Kotlin.getCallableRef('moveTo', function ($receiver, x, y) {
      return $receiver.moveTo_lu1900$(x, y), Unit;
    }.bind(null, visitor));
    var lineTo = Kotlin.getCallableRef('lineTo', function ($receiver, x, y) {
      return $receiver.lineTo_lu1900$(x, y), Unit;
    }.bind(null, visitor));
    var quadTo = Kotlin.getCallableRef('quadTo', function ($receiver, cx, cy, ax, ay) {
      return $receiver.quadTo_6y0v78$(cx, cy, ax, ay), Unit;
    }.bind(null, visitor));
    var cubicTo = Kotlin.getCallableRef('cubicTo', function ($receiver, cx1, cy1, cx2, cy2, ax, ay) {
      return $receiver.cubicTo_15yvbs$(cx1, cy1, cx2, cy2, ax, ay), Unit;
    }.bind(null, visitor));
    var close = Kotlin.getCallableRef('close', function ($receiver) {
  ...
  function VectorPath$Winding$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.VectorPath.Winding.' + name);
    }
  }
  ...
  BinPacker$Companion.prototype.packSeveral_6g33wa$ = defineInlineFunction('korma-js.com.soywiz.korma.geom.binpack.BinPacker.Companion.packSeveral_6g33wa$', wrapFunction(function () {
    ...
    return function (maxWidth, maxHeight, items) {
      return this.packSeveral_7eyens$(Kotlin.numberToDouble(maxWidth), Kotlin.numberToDouble(maxHeight), items, BinPacker$Companion$packSeveral$lambda);
    };
  }));
  ...
  MaxRects.prototype.quickFindPositionForNewNodeBestAreaFit_0 = function (width, height) {
    var tmp$;
    var score = IntCompanionObject.MAX_VALUE;
    var areaFit;
  ...
  function Clipper$ClipType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.ClipType.' + name);
    }
  }
  ...
  function Clipper$Direction$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.Direction.' + name);
    }
  }
  ...
  function Clipper$EndType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.EndType.' + name);
    }
  }
  ...
  function Clipper$JoinType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.JoinType.' + name);
    }
  }
  ...
  function Clipper$PolyFillType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.PolyFillType.' + name);
    }
  }
  ...
  function Clipper$PolyType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Clipper.PolyType.' + name);
    }
  }
  ...
  ClipperBase.prototype.addPath_lh39fr$ = function (pg, polyType, Closed) {
    ...
    while (true) {
      tmp$_4 = e.current;
      tmp$_3 = ((tmp$_2 = e.next) != null ? tmp$_2 : Kotlin.throwNPE()).current;
      if ((tmp$_4 != null ? tmp$_4.equals(tmp$_3) : null) && (Closed || !Kotlin.equals(e.next, eStart))) {
        if (e === e.next) {
          break;
        }
        if (e === eStart) {
          eStart = (tmp$_5 = e.next) != null ? tmp$_5 : Kotlin.throwNPE();
        }
      ...
      if (e.prev === e.next) {
        ...
        if ((Closed ? Points_getInstance().slopesEqual_immp3h$(((tmp$_6 = e.prev) != null ? tmp$_6 : Kotlin.throwNPE()).current, e.current, ((tmp$_7 = e.next) != null ? tmp$_7 : Kotlin.throwNPE()).current) : false) ? !!this.isPreserveCollinear ? !Points_getInstance().isPt2BetweenPt1AndPt3_immp3h$(((tmp$_8 = e.prev) != null ? tmp$_8 : Kotlin.throwNPE()).current, e.current, ((tmp$_9 = e.next) != null ? tmp$_9 : Kotlin.throwNPE()).current) : true : false) {
          if (e === eStart) {
            eStart = (tmp$_10 = e.next) != null ? tmp$_10 : Kotlin.throwNPE();
          }
          e = ClipperBase$Companion_getInstance().removeEdge_0(e);
          e = (tmp$_11 = e.prev) != null ? tmp$_11 : Kotlin.throwNPE();
          eLoopStop = e;
          continue;
        }
      }
      e = (tmp$_12 = e.next) != null ? tmp$_12 : Kotlin.throwNPE();
    ...
    if (!Closed) {
      ...
      ((tmp$_13 = eStart.prev) != null ? tmp$_13 : Kotlin.throwNPE()).outIdx = Edge$Companion_getInstance().SKIP;
    }
    e = eStart;
    do {
      ClipperBase$Companion_getInstance().initEdge2_0(e, polyType);
      e = (tmp$_14 = e.next) != null ? tmp$_14 : Kotlin.throwNPE();
    ...
    if (IsFlat) {
      ...
      ((tmp$_15 = e.prev) != null ? tmp$_15 : Kotlin.throwNPE()).outIdx = Edge$Companion_getInstance().SKIP;
      if (((tmp$_16 = e.prev) != null ? tmp$_16 : Kotlin.throwNPE()).bot.x < ((tmp$_17 = e.prev) != null ? tmp$_17 : Kotlin.throwNPE()).top.x) {
        ((tmp$_18 = e.prev) != null ? tmp$_18 : Kotlin.throwNPE()).reverseHorizontal();
      }
      ...
      locMin.rightBound = e;
      ((tmp$_19 = locMin.rightBound) != null ? tmp$_19 : Kotlin.throwNPE()).side = Edge$Side$RIGHT_getInstance();
      ((tmp$_20 = locMin.rightBound) != null ? tmp$_20 : Kotlin.throwNPE()).windDelta = 0;
      while (((tmp$_21 = e.next) != null ? tmp$_21 : Kotlin.throwNPE()).outIdx !== Edge$Companion_getInstance().SKIP) {
        e.nextInLML = e.next;
        if (e.bot.x !== ((tmp$_22 = e.prev) != null ? tmp$_22 : Kotlin.throwNPE()).top.x) {
          e.reverseHorizontal();
        }
        e = (tmp$_23 = e.next) != null ? tmp$_23 : Kotlin.throwNPE();
      }
    ...
    var EMin = null;
    tmp$_27 = ((tmp$_24 = e.prev) != null ? tmp$_24 : Kotlin.throwNPE()).bot;
    tmp$_26 = ((tmp$_25 = e.prev) != null ? tmp$_25 : Kotlin.throwNPE()).top;
    if (tmp$_27 != null ? tmp$_27.equals(tmp$_26) : null) {
      e = (tmp$_28 = e.next) != null ? tmp$_28 : Kotlin.throwNPE();
    }
    while (true) {
      e = e.findNextLocMin();
      if (e === EMin)
      ...
      locMin_0.next = null;
      locMin_0.y = e.bot.y;
      if (e.deltaX < ((tmp$_29 = e.prev) != null ? tmp$_29 : Kotlin.throwNPE()).deltaX) {
      ...
      ((tmp$_30 = locMin_0.leftBound) != null ? tmp$_30 : Kotlin.throwNPE()).side = Edge$Side$LEFT_getInstance();
      ((tmp$_31 = locMin_0.rightBound) != null ? tmp$_31 : Kotlin.throwNPE()).side = Edge$Side$RIGHT_getInstance();
      tmp$_34 = (tmp$_33 = locMin_0.leftBound) != null ? tmp$_33 : Kotlin.throwNPE();
      if (!Closed)
        tmp$_32 = 0;
      else {
        var tmp$_41;
        if (((tmp$_41 = locMin_0.leftBound) != null ? tmp$_41 : Kotlin.throwNPE()).next === locMin_0.rightBound)
          tmp$_32 = -1;
        else
          tmp$_32 = 1;
      }
      tmp$_34.windDelta = tmp$_32;
      ((tmp$_36 = locMin_0.rightBound) != null ? tmp$_36 : Kotlin.throwNPE()).windDelta = -((tmp$_35 = locMin_0.leftBound) != null ? tmp$_35 : Kotlin.throwNPE()).windDelta;
      e = this.processBound_rr243z$_0((tmp$_37 = locMin_0.leftBound) != null ? tmp$_37 : Kotlin.throwNPE(), leftBoundIsForward);
      if (e.outIdx === Edge$Companion_getInstance().SKIP)
        e = this.processBound_rr243z$_0(e, leftBoundIsForward);
      var E2 = this.processBound_rr243z$_0((tmp$_38 = locMin_0.rightBound) != null ? tmp$_38 : Kotlin.throwNPE(), !leftBoundIsForward);
      if (E2.outIdx === Edge$Companion_getInstance().SKIP)
        E2 = this.processBound_rr243z$_0(E2, !leftBoundIsForward);
      if (((tmp$_39 = locMin_0.leftBound) != null ? tmp$_39 : Kotlin.throwNPE()).outIdx === Edge$Companion_getInstance().SKIP) {
        locMin_0.leftBound = null;
      }
       else if (((tmp$_40 = locMin_0.rightBound) != null ? tmp$_40 : Kotlin.throwNPE()).outIdx === Edge$Companion_getInstance().SKIP) {
  ...
  ClipperBase.prototype.disposeLocalMinimaList_hjt0bo$_0 = function () {
    ...
    while (this.minimaList != null) {
      var tmpLm = ((tmp$ = this.minimaList) != null ? tmp$ : Kotlin.throwNPE()).next;
      this.minimaList = null;
  ...
  ClipperBase.prototype.insertLocalMinima_mrxmjb$_0 = function (newLm) {
    ...
    if (this.minimaList == null) {
     ...
     else if (newLm.y >= ((tmp$ = this.minimaList) != null ? tmp$ : Kotlin.throwNPE()).y) {
      newLm.next = this.minimaList;
      this.minimaList = newLm;
    }
     else {
      var tmpLm = (tmp$_0 = this.minimaList) != null ? tmp$_0 : Kotlin.throwNPE();
      while (tmpLm.next != null && newLm.y < ((tmp$_1 = tmpLm.next) != null ? tmp$_1 : Kotlin.throwNPE()).y) {
        tmpLm = (tmp$_2 = tmpLm.next) != null ? tmp$_2 : Kotlin.throwNPE();
      }
  ...
  ClipperBase.prototype.popLocalMinima = function () {
    ...
    if (this.currentLM == null)
      return;
    this.currentLM = ((tmp$ = this.currentLM) != null ? tmp$ : Kotlin.throwNPE()).next;
  };
  ClipperBase.prototype.processBound_rr243z$_0 = function (ee, LeftBoundIsForward) {
    ...
    if (result.outIdx === Edge$Companion_getInstance().SKIP) {
      e = result;
      if (LeftBoundIsForward) {
        while (e.top.y === ((tmp$ = e.next) != null ? tmp$ : Kotlin.throwNPE()).bot.y)
          e = (tmp$_0 = e.next) != null ? tmp$_0 : Kotlin.throwNPE();
        while (e !== result && e.deltaX === Edge$Companion_getInstance().HORIZONTAL)
          e = (tmp$_1 = e.prev) != null ? tmp$_1 : Kotlin.throwNPE();
      }
       else {
        while (e.top.y === ((tmp$_2 = e.prev) != null ? tmp$_2 : Kotlin.throwNPE()).bot.y)
          e = (tmp$_3 = e.prev) != null ? tmp$_3 : Kotlin.throwNPE();
        while (e !== result && e.deltaX === Edge$Companion_getInstance().HORIZONTAL)
          e = (tmp$_4 = e.next) != null ? tmp$_4 : Kotlin.throwNPE();
      }
      if (e === result) {
        result = LeftBoundIsForward ? (tmp$_5 = e.next) != null ? tmp$_5 : Kotlin.throwNPE() : (tmp$_6 = e.prev) != null ? tmp$_6 : Kotlin.throwNPE();
      }
       else {
        e = LeftBoundIsForward ? (tmp$_7 = result.next) != null ? tmp$_7 : Kotlin.throwNPE() : (tmp$_8 = result.prev) != null ? tmp$_8 : Kotlin.throwNPE();
        var locMin = new ClipperBase$LocalMinima(this);
        locMin.next = null;
        locMin.y = e.bot.y;
        locMin.leftBound = null;
    ...
    if (e.deltaX === Edge$Companion_getInstance().HORIZONTAL) {
      EStart = LeftBoundIsForward ? (tmp$_9 = e.prev) != null ? tmp$_9 : Kotlin.throwNPE() : (tmp$_10 = e.next) != null ? tmp$_10 : Kotlin.throwNPE();
    ...
    EStart = e;
    if (LeftBoundIsForward) {
      while (result.top.y === ((tmp$_11 = result.next) != null ? tmp$_11 : Kotlin.throwNPE()).bot.y && ((tmp$_12 = result.next) != null ? tmp$_12 : Kotlin.throwNPE()).outIdx !== Edge$Companion_getInstance().SKIP) {
        result = (tmp$_13 = result.next) != null ? tmp$_13 : Kotlin.throwNPE();
      }
      if (result.deltaX === Edge$Companion_getInstance().HORIZONTAL && ((tmp$_14 = result.next) != null ? tmp$_14 : Kotlin.throwNPE()).outIdx !== Edge$Companion_getInstance().SKIP) {
        Horz = result;
        while (((tmp$_15 = Horz.prev) != null ? tmp$_15 : Kotlin.throwNPE()).deltaX === Edge$Companion_getInstance().HORIZONTAL) {
          Horz = (tmp$_16 = Horz.prev) != null ? tmp$_16 : Kotlin.throwNPE();
        }
        if (((tmp$_17 = Horz.prev) != null ? tmp$_17 : Kotlin.throwNPE()).top.x === ((tmp$_18 = result.next) != null ? tmp$_18 : Kotlin.throwNPE()).top.x) {
          if (!LeftBoundIsForward) {
            result = (tmp$_19 = Horz.prev) != null ? tmp$_19 : Kotlin.throwNPE();
          }
        }
         else if (((tmp$_20 = Horz.prev) != null ? tmp$_20 : Kotlin.throwNPE()).top.x > ((tmp$_21 = result.next) != null ? tmp$_21 : Kotlin.throwNPE()).top.x) {
          result = (tmp$_22 = Horz.prev) != null ? tmp$_22 : Kotlin.throwNPE();
        }
      }
      while (e !== result) {
        e.nextInLML = e.next;
        if (e.deltaX === Edge$Companion_getInstance().HORIZONTAL && e !== EStart && e.bot.x !== ((tmp$_23 = e.prev) != null ? tmp$_23 : Kotlin.throwNPE()).top.x) {
          e.reverseHorizontal();
        }
        e = (tmp$_24 = e.next) != null ? tmp$_24 : Kotlin.throwNPE();
      }
      if (e.deltaX === Edge$Companion_getInstance().HORIZONTAL && e !== EStart && e.bot.x !== ((tmp$_25 = e.prev) != null ? tmp$_25 : Kotlin.throwNPE()).top.x) {
        e.reverseHorizontal();
      }
      result = (tmp$_26 = result.next) != null ? tmp$_26 : Kotlin.throwNPE();
    }
     else {
      while (result.top.y === ((tmp$_27 = result.prev) != null ? tmp$_27 : Kotlin.throwNPE()).bot.y && ((tmp$_28 = result.prev) != null ? tmp$_28 : Kotlin.throwNPE()).outIdx !== Edge$Companion_getInstance().SKIP)
        result = (tmp$_29 = result.prev) != null ? tmp$_29 : Kotlin.throwNPE();
      if (result.deltaX === Edge$Companion_getInstance().HORIZONTAL && ((tmp$_30 = result.prev) != null ? tmp$_30 : Kotlin.throwNPE()).outIdx !== Edge$Companion_getInstance().SKIP) {
        Horz = result;
        while (((tmp$_31 = Horz.next) != null ? tmp$_31 : Kotlin.throwNPE()).deltaX === Edge$Companion_getInstance().HORIZONTAL)
          Horz = (tmp$_32 = Horz.next) != null ? tmp$_32 : Kotlin.throwNPE();
        if (((tmp$_33 = Horz.next) != null ? tmp$_33 : Kotlin.throwNPE()).top.x === ((tmp$_34 = result.prev) != null ? tmp$_34 : Kotlin.throwNPE()).top.x) {
          if (!LeftBoundIsForward)
            result = (tmp$_35 = Horz.next) != null ? tmp$_35 : Kotlin.throwNPE();
        }
         else if (((tmp$_36 = Horz.next) != null ? tmp$_36 : Kotlin.throwNPE()).top.x > ((tmp$_37 = result.prev) != null ? tmp$_37 : Kotlin.throwNPE()).top.x)
          result = (tmp$_38 = Horz.next) != null ? tmp$_38 : Kotlin.throwNPE();
      }
      while (e !== result) {
        e.nextInLML = e.prev;
        if (e.deltaX === Edge$Companion_getInstance().HORIZONTAL && e !== EStart && e.bot.x !== ((tmp$_39 = e.next) != null ? tmp$_39 : Kotlin.throwNPE()).top.x) {
          e.reverseHorizontal();
        }
        e = (tmp$_40 = e.prev) != null ? tmp$_40 : Kotlin.throwNPE();
      }
      if (e.deltaX === Edge$Companion_getInstance().HORIZONTAL && e !== EStart && e.bot.x !== ((tmp$_41 = e.next) != null ? tmp$_41 : Kotlin.throwNPE()).top.x) {
        e.reverseHorizontal();
      }
      result = (tmp$_42 = result.prev) != null ? tmp$_42 : Kotlin.throwNPE();
    }
    return result;
  };
  ...
  ClipperBase$Companion.prototype.initEdge2_0 = function (e, polyType) {
    var tmp$, tmp$_0, tmp$_1;
    if (e.current.y >= ((tmp$ = e.next) != null ? tmp$ : Kotlin.throwNPE()).current.y) {
      e.bot = Vector2_init_2(e.current);
      e.top = Vector2_init_2(((tmp$_0 = e.next) != null ? tmp$_0 : Kotlin.throwNPE()).current);
    }
     else {
      e.top = Vector2_init_2(e.current);
      e.bot = Vector2_init_2(((tmp$_1 = e.next) != null ? tmp$_1 : Kotlin.throwNPE()).current);
    }
    e.updateDeltaX();
    e.polyTyp = polyType;
  };
  ...
  ClipperBase$Companion.prototype.removeEdge_0 = function (e) {
    var tmp$, tmp$_0;
    ((tmp$ = e.prev) != null ? tmp$ : Kotlin.throwNPE()).next = e.next;
    ((tmp$_0 = e.next) != null ? tmp$_0 : Kotlin.throwNPE()).prev = e.prev;
    var result = e.next;
    e.prev = null;
    return result != null ? result : Kotlin.throwNPE();
  };
  ...
  function ClipperOffset(miterLimit, arcTolerance) {
    ...
    ((tmp$ = this.lowest_0) != null ? tmp$ : Kotlin.throwNPE()).x = -1;
  ...
  ClipperOffset.prototype.addPath_613o8z$ = function (path, joinType, endType) {
    ...
    if (((tmp$_0 = this.lowest_0) != null ? tmp$_0 : Kotlin.throwNPE()).x < 0) {
      this.lowest_0 = Vector2_init_0(this.polyNodes_0.childCount - 1 | 0, k);
    }
     else {
      var ip = this.polyNodes_0.getChilds().get_za3lpa$(((tmp$_1 = this.lowest_0) != null ? tmp$_1 : Kotlin.throwNPE()).x | 0).polygon.get_za3lpa$(((tmp$_2 = this.lowest_0) != null ? tmp$_2 : Kotlin.throwNPE()).y | 0);
  ...
  ClipperOffset.prototype.doMiter_0 = function (j, k, r) {
    ...
    ((tmp$ = this.destPoly_0) != null ? tmp$ : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(((tmp$_0 = this.srcPoly_0) != null ? tmp$_0 : Kotlin.throwNPE()).get_za3lpa$(j).x + (this.normals_0.get_za3lpa$(k).x + this.normals_0.get_za3lpa$(j).x) * q) | 0, round(((tmp$_1 = this.srcPoly_0) != null ? tmp$_1 : Kotlin.throwNPE()).get_za3lpa$(j).y + (this.normals_0.get_za3lpa$(k).y + this.normals_0.get_za3lpa$(j).y) * q) | 0));
  };
  ClipperOffset.prototype.doOffset_0 = function (delta) {
    ...
    if (ClipperOffset$Companion_getInstance().nearZero_0(delta)) {
      ...
      for (var i = 0; i <= tmp$; i++) {
        ...
        if (Kotlin.equals(node.endType, Clipper$EndType$CLOSED_POLYGON_getInstance())) {
          ((tmp$_0 = this.destPolys_0) != null ? tmp$_0 : Kotlin.throwNPE()).add_11rb$(node.polygon);
        }
      }
      return;
    }
    ...
    for (var i_0 = 0; i_0 <= tmp$_1; i_0++) {
      ...
      var len = ((tmp$_2 = this.srcPoly_0) != null ? tmp$_2 : Kotlin.throwNPE()).size;
      if (len === 0 || (delta <= 0 && (len < 3 || !Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_POLYGON_getInstance())))) {
        continue;
      }
      this.destPoly_0 = new Path();
      if (len === 1) {
        if (Kotlin.equals(node_0.joinType, Clipper$JoinType$ROUND_getInstance())) {
          var X = 1.0;
          var Y = 0.0;
          var j = 1;
          while (j <= steps) {
            ((tmp$_3 = this.destPoly_0) != null ? tmp$_3 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(((tmp$_4 = this.srcPoly_0) != null ? tmp$_4 : Kotlin.throwNPE()).get_za3lpa$(0).x + X * delta) | 0, round(((tmp$_5 = this.srcPoly_0) != null ? tmp$_5 : Kotlin.throwNPE()).get_za3lpa$(0).y + Y * delta) | 0));
            var X2 = X;
          ...
          for (var j_0 = 0; j_0 <= 3; j_0++) {
            ((tmp$_6 = this.destPoly_0) != null ? tmp$_6 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(((tmp$_7 = this.srcPoly_0) != null ? tmp$_7 : Kotlin.throwNPE()).get_za3lpa$(0).x + X_0 * delta) | 0, round(((tmp$_8 = this.srcPoly_0) != null ? tmp$_8 : Kotlin.throwNPE()).get_za3lpa$(0).y + Y_0 * delta) | 0));
            if (X_0 < 0) {
              X_0 = 1.0;
            }
             else if (Y_0 < 0) {
        ...
        ((tmp$_9 = this.destPolys_0) != null ? tmp$_9 : Kotlin.throwNPE()).add_11rb$((tmp$_10 = this.destPoly_0) != null ? tmp$_10 : Kotlin.throwNPE());
        continue;
      }
      this.normals_0.clear();
      tmp$_11 = len - 1 - 1 | 0;
      for (var j_1 = 0; j_1 <= tmp$_11; j_1++) {
        this.normals_0.add_11rb$(Points_getInstance().getUnitNormal_g6xq6k$(((tmp$_12 = this.srcPoly_0) != null ? tmp$_12 : Kotlin.throwNPE()).get_za3lpa$(j_1), ((tmp$_13 = this.srcPoly_0) != null ? tmp$_13 : Kotlin.throwNPE()).get_za3lpa$(j_1 + 1 | 0)));
      }
      if (Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_LINE_getInstance()) || Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_POLYGON_getInstance())) {
        this.normals_0.add_11rb$(Points_getInstance().getUnitNormal_g6xq6k$(((tmp$_14 = this.srcPoly_0) != null ? tmp$_14 : Kotlin.throwNPE()).get_za3lpa$(len - 1 | 0), ((tmp$_15 = this.srcPoly_0) != null ? tmp$_15 : Kotlin.throwNPE()).get_za3lpa$(0)));
      }
       else {
        this.normals_0.add_11rb$(Vector2_init_2(this.normals_0.get_za3lpa$(len - 2 | 0)));
      }
      if (Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_POLYGON_getInstance())) {
        var k = new Int32Array([len - 1 | 0]);
        tmp$_16 = len - 1 | 0;
        for (var j_2 = 0; j_2 <= tmp$_16; j_2++) {
          this.offsetPoint_0(j_2, k, (tmp$_17 = node_0.joinType) != null ? tmp$_17 : Kotlin.throwNPE());
        }
        ((tmp$_18 = this.destPolys_0) != null ? tmp$_18 : Kotlin.throwNPE()).add_11rb$((tmp$_19 = this.destPoly_0) != null ? tmp$_19 : Kotlin.throwNPE());
      }
       else if (Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_LINE_getInstance())) {
        var k_0 = new Int32Array([len - 1 | 0]);
        tmp$_20 = len - 1 | 0;
        for (var j_3 = 0; j_3 <= tmp$_20; j_3++) {
          this.offsetPoint_0(j_3, k_0, (tmp$_21 = node_0.joinType) != null ? tmp$_21 : Kotlin.throwNPE());
        }
        ((tmp$_22 = this.destPolys_0) != null ? tmp$_22 : Kotlin.throwNPE()).add_11rb$((tmp$_23 = this.destPoly_0) != null ? tmp$_23 : Kotlin.throwNPE());
        this.destPoly_0 = new Path();
        ...
        for (var j_5 = len - 1 | 0; j_5 >= 0; j_5--) {
          this.offsetPoint_0(j_5, k_0, (tmp$_24 = node_0.joinType) != null ? tmp$_24 : Kotlin.throwNPE());
        }
        ((tmp$_25 = this.destPolys_0) != null ? tmp$_25 : Kotlin.throwNPE()).add_11rb$((tmp$_26 = this.destPoly_0) != null ? tmp$_26 : Kotlin.throwNPE());
      }
       else {
        var k_1 = new Int32Array(1);
        tmp$_27 = len - 1 - 1 | 0;
        for (var j_6 = 1; j_6 <= tmp$_27; j_6++) {
          this.offsetPoint_0(j_6, k_1, (tmp$_28 = node_0.joinType) != null ? tmp$_28 : Kotlin.throwNPE());
        }
        var pt1;
        if (Kotlin.equals(node_0.endType, Clipper$EndType$OPEN_BUTT_getInstance())) {
          var j_7 = len - 1 | 0;
          pt1 = Vector2_init_0(round(((tmp$_29 = this.srcPoly_0) != null ? tmp$_29 : Kotlin.throwNPE()).get_za3lpa$(j_7).x + this.normals_0.get_za3lpa$(j_7).x * delta) | 0, round(((tmp$_30 = this.srcPoly_0) != null ? tmp$_30 : Kotlin.throwNPE()).get_za3lpa$(j_7).y + this.normals_0.get_za3lpa$(j_7).y * delta) | 0);
          ((tmp$_31 = this.destPoly_0) != null ? tmp$_31 : Kotlin.throwNPE()).add_11rb$(pt1);
          pt1 = Vector2_init_0(round(((tmp$_32 = this.srcPoly_0) != null ? tmp$_32 : Kotlin.throwNPE()).get_za3lpa$(j_7).x - this.normals_0.get_za3lpa$(j_7).x * delta) | 0, round(((tmp$_33 = this.srcPoly_0) != null ? tmp$_33 : Kotlin.throwNPE()).get_za3lpa$(j_7).y - this.normals_0.get_za3lpa$(j_7).y * delta) | 0);
          ((tmp$_34 = this.destPoly_0) != null ? tmp$_34 : Kotlin.throwNPE()).add_11rb$(pt1);
        }
         else {
          var j_8 = len - 1 | 0;
          k_1[0] = len - 2 | 0;
          ...
          if (Kotlin.equals(node_0.endType, Clipper$EndType$OPEN_SQUARE_getInstance())) {
        ...
        for (var j_10 = k_1[0] - 1 | 0; j_10 >= 1; j_10--) {
          this.offsetPoint_0(j_10, k_1, (tmp$_35 = node_0.joinType) != null ? tmp$_35 : Kotlin.throwNPE());
        }
        if (Kotlin.equals(node_0.endType, Clipper$EndType$OPEN_BUTT_getInstance())) {
          pt1 = Vector2_init_0(round(((tmp$_36 = this.srcPoly_0) != null ? tmp$_36 : Kotlin.throwNPE()).get_za3lpa$(0).x - this.normals_0.get_za3lpa$(0).x * delta) | 0, round(((tmp$_37 = this.srcPoly_0) != null ? tmp$_37 : Kotlin.throwNPE()).get_za3lpa$(0).y - this.normals_0.get_za3lpa$(0).y * delta) | 0);
          ((tmp$_38 = this.destPoly_0) != null ? tmp$_38 : Kotlin.throwNPE()).add_11rb$(pt1);
          pt1 = Vector2_init_0(round(((tmp$_39 = this.srcPoly_0) != null ? tmp$_39 : Kotlin.throwNPE()).get_za3lpa$(0).x + this.normals_0.get_za3lpa$(0).x * delta) | 0, round(((tmp$_40 = this.srcPoly_0) != null ? tmp$_40 : Kotlin.throwNPE()).get_za3lpa$(0).y + this.normals_0.get_za3lpa$(0).y * delta) | 0);
          ((tmp$_41 = this.destPoly_0) != null ? tmp$_41 : Kotlin.throwNPE()).add_11rb$(pt1);
        }
         else {
          k_1[0] = 1;
          this.inA_0 = 0.0;
        ...
        ((tmp$_42 = this.destPolys_0) != null ? tmp$_42 : Kotlin.throwNPE()).add_11rb$((tmp$_43 = this.destPoly_0) != null ? tmp$_43 : Kotlin.throwNPE());
      }
    }
  };
  ClipperOffset.prototype.doRound_0 = function (j, k) {
    ...
    var steps = Math_getInstance().max_vux9f0$(round(this.stepsPerRad_0 * Math_0.abs(a)) | 0, 1);
    var X = this.normals_0.get_za3lpa$(k).x;
    var Y = this.normals_0.get_za3lpa$(k).y;
    var X2;
    for (var i = 0; i < steps; i++) {
      ((tmp$ = this.destPoly_0) != null ? tmp$ : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(((tmp$_0 = this.srcPoly_0) != null ? tmp$_0 : Kotlin.throwNPE()).get_za3lpa$(j).x + X * this.delta_0) | 0, round(((tmp$_1 = this.srcPoly_0) != null ? tmp$_1 : Kotlin.throwNPE()).get_za3lpa$(j).y + Y * this.delta_0) | 0));
      X2 = X;
      X = X * this.cos_0 - this.sin_0 * Y;
      Y = X2 * this.sin_0 + Y * this.cos_0;
    }
    ((tmp$_2 = this.destPoly_0) != null ? tmp$_2 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(((tmp$_3 = this.srcPoly_0) != null ? tmp$_3 : Kotlin.throwNPE()).get_za3lpa$(j).x + this.normals_0.get_za3lpa$(j).x * this.delta_0) | 0, round(((tmp$_4 = this.srcPoly_0) != null ? tmp$_4 : Kotlin.throwNPE()).get_za3lpa$(j).y + this.normals_0.get_za3lpa$(j).y * this.delta_0) | 0));
  };
  ClipperOffset.prototype.doSquare_0 = function (j, k) {
    ...
    var sjx = ((tmp$ = this.srcPoly_0) != null ? tmp$ : Kotlin.throwNPE()).get_za3lpa$(j).x;
    var sjy = ((tmp$_0 = this.srcPoly_0) != null ? tmp$_0 : Kotlin.throwNPE()).get_za3lpa$(j).y;
    var y = this.inA_0;
    var x = nkx * njx + nky * njy;
    var a = Math_0.atan2(y, x) / 4;
    var dx = Math_0.tan(a);
    ((tmp$_1 = this.destPoly_0) != null ? tmp$_1 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(sjx + this.delta_0 * (nkx - nky * dx)) | 0, round(sjy + this.delta_0 * (nky + nkx * dx)) | 0));
    ((tmp$_2 = this.destPoly_0) != null ? tmp$_2 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(sjx + this.delta_0 * (njx + njy * dx)) | 0, round(sjy + this.delta_0 * (njy - njx * dx)) | 0));
  };
  ClipperOffset.prototype.execute_nn3i1b$ = function (solution, delta) {
    ...
    clpr.addPaths_kw2pds$((tmp$ = this.destPolys_0) != null ? tmp$ : Kotlin.throwNPE(), Clipper$PolyType$SUBJECT_getInstance(), true);
    if (delta > 0) {
      ...
      var r = ((tmp$_0 = this.destPolys_0) != null ? tmp$_0 : Kotlin.throwNPE()).bounds;
  ...
  ClipperOffset.prototype.fixOrientations_0 = function () {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    if (((tmp$ = this.lowest_0) != null ? tmp$ : Kotlin.throwNPE()).x >= 0 ? !this.polyNodes_0._childs.get_za3lpa$(((tmp$_0 = this.lowest_0) != null ? tmp$_0 : Kotlin.throwNPE()).x | 0).polygon.orientation() : false) {
      tmp$_1 = this.polyNodes_0.childCount;
      for (var i = 0; i < tmp$_1; i++) {
        var node = this.polyNodes_0._childs.get_za3lpa$(i);
        if (Kotlin.equals(node.endType, Clipper$EndType$CLOSED_POLYGON_getInstance()) || (Kotlin.equals(node.endType, Clipper$EndType$CLOSED_LINE_getInstance()) && node.polygon.orientation())) {
      ...
      for (var i_0 = 0; i_0 < tmp$_2; i_0++) {
        ...
        if (Kotlin.equals(node_0.endType, Clipper$EndType$CLOSED_LINE_getInstance()) && !node_0.polygon.orientation()) {
  ...
  ClipperOffset.prototype.offsetPoint_0 = function (j, kV, jointype) {
    ...
    if (Math_0.abs(a) < 1.0) {
      ...
      if (cosA > 0) {
        ((tmp$_1 = this.destPoly_0) != null ? tmp$_1 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(sjx + nkx * this.delta_0) | 0, round(sjy + nky * this.delta_0) | 0));
        return;
      }
    }
    ...
    if (this.inA_0 * this.delta_0 < 0) {
      ((tmp$_2 = this.destPoly_0) != null ? tmp$_2 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(sjx + nkx * this.delta_0) | 0, round(sjy + nky * this.delta_0) | 0));
      ((tmp$_3 = this.destPoly_0) != null ? tmp$_3 : Kotlin.throwNPE()).add_11rb$(((tmp$_4 = this.srcPoly_0) != null ? tmp$_4 : Kotlin.throwNPE()).get_za3lpa$(j));
      ((tmp$_5 = this.destPoly_0) != null ? tmp$_5 : Kotlin.throwNPE()).add_11rb$(Vector2_init_0(round(sjx + njx * this.delta_0) | 0, round(sjy + njy * this.delta_0) | 0));
    }
     else {
      if (Kotlin.equals(jointype, Clipper$JoinType$MITER_getInstance())) {
       ...
       else if (Kotlin.equals(jointype, Clipper$JoinType$SQUARE_getInstance()))
        this.doSquare_0(j, k);
      else if (Kotlin.equals(jointype, Clipper$JoinType$ROUND_getInstance()))
        this.doRound_0(j, k);
    }
    kV[0] = j;
  };
  ...
  DefaultClipper.prototype.addEdgeToSEL_0 = function (edge) {
    ...
    if (this.sortedEdges_0 == null) {
      ...
      edge.prevInSEL = null;
      ((tmp$ = this.sortedEdges_0) != null ? tmp$ : Kotlin.throwNPE()).prevInSEL = edge;
      this.sortedEdges_0 = edge;
    }
  };
  ...
  DefaultClipper.prototype.addOutPt_0 = function (e, pt) {
    ...
    if (e.outIdx < 0) {
      ...
      var op = (tmp$ = outRec_0.points) != null ? tmp$ : Kotlin.throwNPE();
      if (ToFront && (pt != null ? pt.equals(op.pt) : null)) {
        return op;
      }
       else {
        if (!ToFront) {
          tmp$_1 = ((tmp$_0 = op.prev) != null ? tmp$_0 : Kotlin.throwNPE()).pt;
          tmp$_2 = pt != null ? pt.equals(tmp$_1) : null;
        }
         else
          tmp$_2 = false;
        if (tmp$_2) {
          return (tmp$_3 = op.prev) != null ? tmp$_3 : Kotlin.throwNPE();
        }
      }
      ...
      ((tmp$_4 = newOp_0.prev) != null ? tmp$_4 : Kotlin.throwNPE()).next = newOp_0;
      op.prev = newOp_0;
      if (ToFront)
  ...
  DefaultClipper.prototype.appendPolygon_0 = function (e1, e2) {
    ...
    var p1_rt = (tmp$_0 = (p1_lft != null ? p1_lft : Kotlin.throwNPE()).prev) != null ? tmp$_0 : Kotlin.throwNPE();
    var p2_lft = outRec2.points;
    var p2_rt = (tmp$_1 = (p2_lft != null ? p2_lft : Kotlin.throwNPE()).prev) != null ? tmp$_1 : Kotlin.throwNPE();
    var side;
    ...
    if (Kotlin.equals(holeStateRec, outRec2)) {
  ...
  DefaultClipper.prototype.buildIntersectList_0 = function (topY) {
    ...
    while (isModified && this.sortedEdges_0 != null) {
      ...
      while ((e != null ? e : Kotlin.throwNPE()).nextInSEL != null) {
        ...
        var pt = array;
        if (e.current.x > (eNext != null ? eNext : Kotlin.throwNPE()).current.x) {
      ...
      if (e.prevInSEL != null) {
        ((tmp$ = e.prevInSEL) != null ? tmp$ : Kotlin.throwNPE()).nextInSEL = null;
      }
       else {
        break;
      }
  ...
  DefaultClipper.prototype.buildResult_0 = function (polyg) {
    ...
    for (var i = tmp$_0; i <= tmp$_1; i += tmp$_2) {
      ...
      if (outRec.points == null)
        continue;
      var p = (tmp$_4 = ((tmp$_3 = outRec.points) != null ? tmp$_3 : Kotlin.throwNPE()).prev) != null ? tmp$_4 : Kotlin.throwNPE();
      ...
      for (var j = 0; j <= tmp$_5; j++) {
        ...
        p = (tmp$_6 = p.prev) != null ? tmp$_6 : Kotlin.throwNPE();
      }
      polyg.add_11rb$(pg);
    }
  };
  DefaultClipper.prototype.buildResult2_0 = function (polytree) {
    ...
    for (var i = tmp$_0; i <= tmp$_1; i += tmp$_2) {
      var outRec = this.polyOuts_0.get_za3lpa$(i);
      var cnt = ((tmp$_3 = outRec.points) != null ? tmp$_3 : Kotlin.throwNPE()).pointCount;
      ...
      outRec.polyNode = pn;
      var op = (tmp$_5 = ((tmp$_4 = outRec.points) != null ? tmp$_4 : Kotlin.throwNPE()).prev) != null ? tmp$_5 : Kotlin.throwNPE();
      tmp$_6 = cnt - 1 | 0;
      for (var j = 0; j <= tmp$_6; j++) {
        pn.polygon.add_11rb$(op.pt);
        op = (tmp$_7 = op.prev) != null ? tmp$_7 : Kotlin.throwNPE();
      }
    }
    ...
    for (var i_0 = tmp$_9; i_0 <= tmp$_10; i_0 += tmp$_11) {
      ...
      if (outRec_0.polyNode == null) {
        ...
        ((tmp$_12 = outRec_0.polyNode) != null ? tmp$_12 : Kotlin.throwNPE()).isOpen = true;
        polytree.addChild_mux8jj$((tmp$_13 = outRec_0.polyNode) != null ? tmp$_13 : Kotlin.throwNPE());
      }
       else if (outRec_0.firstLeft != null && ((tmp$_14 = outRec_0.firstLeft) != null ? tmp$_14 : Kotlin.throwNPE()).polyNode != null) {
        ((tmp$_16 = ((tmp$_15 = outRec_0.firstLeft) != null ? tmp$_15 : Kotlin.throwNPE()).polyNode) != null ? tmp$_16 : Kotlin.throwNPE()).addChild_mux8jj$((tmp$_17 = outRec_0.polyNode) != null ? tmp$_17 : Kotlin.throwNPE());
      }
       else {
        polytree.addChild_mux8jj$((tmp$_18 = outRec_0.polyNode) != null ? tmp$_18 : Kotlin.throwNPE());
      }
    }
  };
  ...
  DefaultClipper.prototype.deleteFromSEL_0 = function (e) {
    ...
    if (SelPrev == null && SelNext == null && !Kotlin.equals(e, this.sortedEdges_0)) {
      return;
    }
    if (SelPrev != null) {
  ...
  DefaultClipper.prototype.doSimplePolygons_0 = function () {
    ...
    while (i < this.polyOuts_0.size) {
      ...
      do {
        var op2 = (tmp$_0 = (op != null ? op : Kotlin.throwNPE()).next) != null ? tmp$_0 : Kotlin.throwNPE();
        while (op2 !== outrec.points) {
          if (((tmp$_1 = op.pt) != null ? tmp$_1.equals(op2.pt) : null) && !Kotlin.equals(op2.next, op) && !Kotlin.equals(op2.prev, op)) {
            var op3 = op.prev;
            var op4 = op2.prev;
            op.prev = op4;
            (op4 != null ? op4 : Kotlin.throwNPE()).next = op;
            op2.prev = op3;
            (op3 != null ? op3 : Kotlin.throwNPE()).next = op2;
            outrec.points = op;
            var outrec2 = this.createOutRec_0();
            outrec2.points = op2;
            this.updateOutPtIdxs_0(outrec2);
            tmp$_3 = (tmp$_2 = outrec2.points) != null ? tmp$_2 : Kotlin.throwNPE();
            tmp$_5 = (tmp$_4 = outrec.points) != null ? tmp$_4 : Kotlin.throwNPE();
            if (DefaultClipper$Companion_getInstance().poly2ContainsPoly1_0(tmp$_3, tmp$_5)) {
              ...
              tmp$_7 = (tmp$_6 = outrec.points) != null ? tmp$_6 : Kotlin.throwNPE();
              tmp$_9 = (tmp$_8 = outrec2.points) != null ? tmp$_8 : Kotlin.throwNPE();
          ...
          op2 = (tmp$_10 = op2.next) != null ? tmp$_10 : Kotlin.throwNPE();
        }
        op = op.next;
      }
  ...
  DefaultClipper.prototype.EdgesAdjacent_0 = function (inode) {
    var tmp$, tmp$_0;
    return ((tmp$ = inode.edge1) != null ? tmp$ : Kotlin.throwNPE()).nextInSEL === inode.Edge2 || ((tmp$_0 = inode.edge1) != null ? tmp$_0 : Kotlin.throwNPE()).prevInSEL === inode.Edge2;
  };
    ...
    try {
      ...
      while (tmp$_0.hasNext()) {
        ...
        if ((outRec_0.isHole ^ this.reverseSolution_0) === outRec_0.area() > 0) {
          ((tmp$_1 = outRec_0.points) != null ? tmp$_1 : Kotlin.throwNPE()).reversePolyPtLinks();
        }
      }
  ...
  DefaultClipper.prototype.fixupFirstLefts1_0 = function (OldOutRec, NewOutRec) {
    ...
    for (var i = tmp$_0; i <= tmp$_1; i += tmp$_2) {
      ...
      var firstLeft = ((tmp$_3 = outRec.firstLeft) != null ? tmp$_3 : Kotlin.throwNPE()).parseFirstLeft();
      if (Kotlin.equals(firstLeft, OldOutRec)) {
        tmp$_5 = (tmp$_4 = outRec.points) != null ? tmp$_4 : Kotlin.throwNPE();
        tmp$_7 = (tmp$_6 = NewOutRec.points) != null ? tmp$_6 : Kotlin.throwNPE();
  ...
  DefaultClipper.prototype.fixupFirstLefts2_0 = function (OldOutRec, NewOutRec) {
    ...
    while (tmp$.hasNext()) {
      var outRec = tmp$.next();
      if (Kotlin.equals(outRec.firstLeft, OldOutRec)) {
        outRec.firstLeft = NewOutRec;
      }
    }
  };
  DefaultClipper.prototype.fixupIntersectionOrder_0 = function () {
    ...
    for (var i = 0; i <= tmp$; i++) {
      ...
      this.swapPositionsInSEL_0((tmp$_0 = this.intersectList_0.get_za3lpa$(i).edge1) != null ? tmp$_0 : Kotlin.throwNPE(), (tmp$_1 = this.intersectList_0.get_za3lpa$(i).Edge2) != null ? tmp$_1 : Kotlin.throwNPE());
    }
    return true;
  };
  DefaultClipper.prototype.fixupOutPolygon_0 = function (outRec) {
    ...
    var pp = (tmp$ = outRec.points) != null ? tmp$ : Kotlin.throwNPE();
    while (true) {
      ...
      tmp$_2 = pp.pt;
      tmp$_1 = ((tmp$_0 = pp.next) != null ? tmp$_0 : Kotlin.throwNPE()).pt;
      if (!(tmp$_2 != null ? tmp$_2.equals(tmp$_1) : null)) {
        tmp$_5 = pp.pt;
        tmp$_4 = ((tmp$_3 = pp.prev) != null ? tmp$_3 : Kotlin.throwNPE()).pt;
        tmp$_6 = tmp$_5 != null ? tmp$_5.equals(tmp$_4) : null;
      }
       else
        tmp$_6 = true;
      if (!tmp$_6 ? Points_getInstance().slopesEqual_immp3h$(((tmp$_7 = pp.prev) != null ? tmp$_7 : Kotlin.throwNPE()).pt, pp.pt, ((tmp$_8 = pp.next) != null ? tmp$_8 : Kotlin.throwNPE()).pt) ? !!this.isPreserveCollinear ? !Points_getInstance().isPt2BetweenPt1AndPt3_immp3h$(((tmp$_9 = pp.prev) != null ? tmp$_9 : Kotlin.throwNPE()).pt, pp.pt, ((tmp$_10 = pp.next) != null ? tmp$_10 : Kotlin.throwNPE()).pt) : true : false : true) {
        lastOK = null;
        ((tmp$_11 = pp.prev) != null ? tmp$_11 : Kotlin.throwNPE()).next = pp.next;
        ((tmp$_12 = pp.next) != null ? tmp$_12 : Kotlin.throwNPE()).prev = pp.prev;
        pp = (tmp$_13 = pp.prev) != null ? tmp$_13 : Kotlin.throwNPE();
      }
       else if (pp === lastOK) {
        break;
      }
        ...
        pp = (tmp$_14 = pp.next) != null ? tmp$_14 : Kotlin.throwNPE();
      }
    }
    outRec.points = pp;
  };
  ...
  DefaultClipper.prototype.insertEdgeIntoAEL_0 = function (edge, startEdge) {
    ...
    if (this.activeEdges_0 == null) {
      ...
      if (sedge == null ? Edge$Companion_getInstance().doesE2InsertBeforeE1_46mff8$((tmp$ = this.activeEdges_0) != null ? tmp$ : Kotlin.throwNPE(), edge) : false) {
        edge.prevInAEL = null;
        edge.nextInAEL = this.activeEdges_0;
        ((tmp$_0 = this.activeEdges_0) != null ? tmp$_0 : Kotlin.throwNPE()).prevInAEL = edge;
        this.activeEdges_0 = edge;
      }
       else {
        if (sedge == null)
          sedge = this.activeEdges_0;
        while ((sedge != null ? sedge : Kotlin.throwNPE()).nextInAEL != null ? !Edge$Companion_getInstance().doesE2InsertBeforeE1_46mff8$((tmp$_1 = sedge.nextInAEL) != null ? tmp$_1 : Kotlin.throwNPE(), edge) : false) {
          sedge = sedge.nextInAEL;
        }
        edge.nextInAEL = sedge.nextInAEL;
        if (sedge.nextInAEL != null)
          ((tmp$_2 = sedge.nextInAEL) != null ? tmp$_2 : Kotlin.throwNPE()).prevInAEL = edge;
  ...
  DefaultClipper.prototype.insertLocalMinimaIntoAEL_0 = function (botY) {
    ...
    while (this.currentLM != null && ((tmp$ = this.currentLM) != null ? tmp$ : Kotlin.throwNPE()).y === botY) {
      var lb = ((tmp$_0 = this.currentLM) != null ? tmp$_0 : Kotlin.throwNPE()).leftBound;
      var rb = ((tmp$_1 = this.currentLM) != null ? tmp$_1 : Kotlin.throwNPE()).rightBound;
      this.popLocalMinima();
      var Op1 = null;
      if (lb == null) {
        this.insertEdgeIntoAEL_0(rb != null ? rb : Kotlin.throwNPE(), null);
        this.updateWindingCount_0(rb);
        if (rb.isContributing_xil744$((tmp$_2 = this.clipFillType_0) != null ? tmp$_2 : Kotlin.throwNPE(), (tmp$_3 = this.subjFillType_0) != null ? tmp$_3 : Kotlin.throwNPE(), (tmp$_4 = this.clipType_0) != null ? tmp$_4 : Kotlin.throwNPE())) {
        ...
        if (lb.isContributing_xil744$((tmp$_5 = this.clipFillType_0) != null ? tmp$_5 : Kotlin.throwNPE(), (tmp$_6 = this.subjFillType_0) != null ? tmp$_6 : Kotlin.throwNPE(), (tmp$_7 = this.clipType_0) != null ? tmp$_7 : Kotlin.throwNPE())) {
        ...
        if (lb.isContributing_xil744$((tmp$_8 = this.clipFillType_0) != null ? tmp$_8 : Kotlin.throwNPE(), (tmp$_9 = this.subjFillType_0) != null ? tmp$_9 : Kotlin.throwNPE(), (tmp$_10 = this.clipType_0) != null ? tmp$_10 : Kotlin.throwNPE())) {
      ...
      if (Op1 != null && rb.isHorizontal && this.ghostJoins_0.size > 0 && rb.windDelta !== 0) {
        ...
        for (var i = tmp$_12; i <= tmp$_13; i += tmp$_14) {
          ...
          if (this.doHorzSegmentsOverlap_0(((tmp$_15 = j.outPt1) != null ? tmp$_15 : Kotlin.throwNPE()).pt.x, ((tmp$_16 = j.offPt) != null ? tmp$_16 : Kotlin.throwNPE()).x, rb.bot.x, rb.top.x)) {
            this.addJoin_0((tmp$_17 = j.outPt1) != null ? tmp$_17 : Kotlin.throwNPE(), Op1, (tmp$_18 = j.offPt) != null ? tmp$_18 : Kotlin.throwNPE());
          }
        }
      }
      if ((lb.outIdx >= 0 && lb.prevInAEL != null && ((tmp$_19 = lb.prevInAEL) != null ? tmp$_19 : Kotlin.throwNPE()).current.x === lb.bot.x && ((tmp$_20 = lb.prevInAEL) != null ? tmp$_20 : Kotlin.throwNPE()).outIdx >= 0 ? Edge$Companion_getInstance().slopesEqual_46mff8$((tmp$_21 = lb.prevInAEL) != null ? tmp$_21 : Kotlin.throwNPE(), lb) : false) && lb.windDelta !== 0 && ((tmp$_22 = lb.prevInAEL) != null ? tmp$_22 : Kotlin.throwNPE()).windDelta !== 0) {
        var Op2 = this.addOutPt_0((tmp$_23 = lb.prevInAEL) != null ? tmp$_23 : Kotlin.throwNPE(), lb.bot);
        this.addJoin_0(Op1 != null ? Op1 : Kotlin.throwNPE(), Op2, lb.top);
      }
      if (lb.nextInAEL !== rb) {
        if ((rb.outIdx >= 0 && ((tmp$_24 = rb.prevInAEL) != null ? tmp$_24 : Kotlin.throwNPE()).outIdx >= 0 ? Edge$Companion_getInstance().slopesEqual_46mff8$((tmp$_25 = rb.prevInAEL) != null ? tmp$_25 : Kotlin.throwNPE(), rb) : false) && rb.windDelta !== 0 && ((tmp$_26 = rb.prevInAEL) != null ? tmp$_26 : Kotlin.throwNPE()).windDelta !== 0) {
          var Op2_0 = this.addOutPt_0((tmp$_27 = rb.prevInAEL) != null ? tmp$_27 : Kotlin.throwNPE(), rb.bot);
          this.addJoin_0(Op1 != null ? Op1 : Kotlin.throwNPE(), Op2_0, rb.top);
        }
        var e = lb.nextInAEL;
        if (e != null) {
          while (e !== rb) {
            this.intersectEdges_0(rb, e != null ? e : Kotlin.throwNPE(), lb.current);
            e = e.nextInAEL;
          }
        }
      }
  ...
  DefaultClipper.prototype.insertScanbeam_0 = function (y) {
    ...
    if (this.scanbeam_0 == null) {
      ...
      ((tmp$ = this.scanbeam_0) != null ? tmp$ : Kotlin.throwNPE()).next = null;
      ((tmp$_0 = this.scanbeam_0) != null ? tmp$_0 : Kotlin.throwNPE()).y = y;
    }
     else if (y > ((tmp$_1 = this.scanbeam_0) != null ? tmp$_1 : Kotlin.throwNPE()).y) {
      ...
      var sb2 = (tmp$_2 = this.scanbeam_0) != null ? tmp$_2 : Kotlin.throwNPE();
      while (sb2.next != null && y <= ((tmp$_3 = sb2.next) != null ? tmp$_3 : Kotlin.throwNPE()).y) {
        sb2 = (tmp$_4 = sb2.next) != null ? tmp$_4 : Kotlin.throwNPE();
      }
      if (y === sb2.y) {
        return;
      }
  ...
  DefaultClipper.prototype.intersectEdges_0 = function (e1, e2, pt) {
    ...
    if (e1.windDelta === 0 || e2.windDelta === 0) {
      if (e1.windDelta === 0 && e2.windDelta === 0) {
       ...
       else if (Kotlin.equals(e1.polyTyp, e2.polyTyp) && e1.windDelta !== e2.windDelta && Kotlin.equals(this.clipType_0, Clipper$ClipType$UNION_getInstance())) {
        if (e1.windDelta === 0) {
          if (e2Contributing) {
            this.addOutPt_0(e1, pt);
            if (e1Contributing) {
       ...
       else if (!Kotlin.equals(e1.polyTyp, e2.polyTyp)) {
        if (e1.windDelta === 0 && abs(e2.windCnt) === 1 && (!Kotlin.equals(this.clipType_0, Clipper$ClipType$UNION_getInstance()) || e2.windCnt2 === 0)) {
          this.addOutPt_0(e1, pt);
          if (e1Contributing) {
            e1.outIdx = Edge$Companion_getInstance().UNASSIGNED;
          }
        }
         else if (e2.windDelta === 0 && abs(e1.windCnt) === 1 && (!Kotlin.equals(this.clipType_0, Clipper$ClipType$UNION_getInstance()) || e1.windCnt2 === 0)) {
          this.addOutPt_0(e2, pt);
          if (e2Contributing) {
            e2.outIdx = Edge$Companion_getInstance().UNASSIGNED;
          }
    ...
    if (Kotlin.equals(e1.polyTyp, e2.polyTyp)) {
      if (e1.isEvenOddFillType_dta898$((tmp$ = this.clipFillType_0) != null ? tmp$ : Kotlin.throwNPE(), (tmp$_0 = this.subjFillType_0) != null ? tmp$_0 : Kotlin.throwNPE())) {
      ...
      if (!e2.isEvenOddFillType_dta898$((tmp$_1 = this.clipFillType_0) != null ? tmp$_1 : Kotlin.throwNPE(), (tmp$_2 = this.subjFillType_0) != null ? tmp$_2 : Kotlin.throwNPE())) {
        e1.windCnt2 = e1.windCnt2 + e2.windDelta | 0;
      }
       else {
        e1.windCnt2 = e1.windCnt2 === 0 ? 1 : 0;
      }
      if (!e1.isEvenOddFillType_dta898$((tmp$_3 = this.clipFillType_0) != null ? tmp$_3 : Kotlin.throwNPE(), (tmp$_4 = this.subjFillType_0) != null ? tmp$_4 : Kotlin.throwNPE())) {
    ...
    var e1FillType2;
    var e2FillType2;
    if (Kotlin.equals(e1.polyTyp, Clipper$PolyType$SUBJECT_getInstance())) {
      e1FillType = (tmp$_5 = this.subjFillType_0) != null ? tmp$_5 : Kotlin.throwNPE();
      e1FillType2 = (tmp$_6 = this.clipFillType_0) != null ? tmp$_6 : Kotlin.throwNPE();
    }
     else {
      e1FillType = (tmp$_7 = this.clipFillType_0) != null ? tmp$_7 : Kotlin.throwNPE();
      e1FillType2 = (tmp$_8 = this.subjFillType_0) != null ? tmp$_8 : Kotlin.throwNPE();
    }
    if (Kotlin.equals(e2.polyTyp, Clipper$PolyType$SUBJECT_getInstance())) {
      e2FillType = (tmp$_9 = this.subjFillType_0) != null ? tmp$_9 : Kotlin.throwNPE();
      e2FillType2 = (tmp$_10 = this.clipFillType_0) != null ? tmp$_10 : Kotlin.throwNPE();
    }
     else {
      e2FillType = (tmp$_11 = this.clipFillType_0) != null ? tmp$_11 : Kotlin.throwNPE();
      e2FillType2 = (tmp$_12 = this.subjFillType_0) != null ? tmp$_12 : Kotlin.throwNPE();
    }
    var e1Wc;
    var e2Wc;
    tmp$_13 = e1FillType;
    if (Kotlin.equals(tmp$_13, Clipper$PolyFillType$POSITIVE_getInstance()))
      e1Wc = e1.windCnt;
    else if (Kotlin.equals(tmp$_13, Clipper$PolyFillType$NEGATIVE_getInstance()))
      e1Wc = -e1.windCnt;
    else
      e1Wc = abs(e1.windCnt);
    tmp$_14 = e2FillType;
    if (Kotlin.equals(tmp$_14, Clipper$PolyFillType$POSITIVE_getInstance()))
      e2Wc = e2.windCnt;
    else if (Kotlin.equals(tmp$_14, Clipper$PolyFillType$NEGATIVE_getInstance()))
      e2Wc = -e2.windCnt;
    else
      e2Wc = abs(e2.windCnt);
    if (e1Contributing && e2Contributing) {
      if (e1Wc !== 0 && e1Wc !== 1 || (e2Wc !== 0 && e2Wc !== 1) || (!Kotlin.equals(e1.polyTyp, e2.polyTyp) && !Kotlin.equals(this.clipType_0, Clipper$ClipType$XOR_getInstance()))) {
      ...
      var e2Wc2;
      tmp$_15 = e1FillType2;
      if (Kotlin.equals(tmp$_15, Clipper$PolyFillType$POSITIVE_getInstance()))
        e1Wc2 = e1.windCnt2;
      else if (Kotlin.equals(tmp$_15, Clipper$PolyFillType$NEGATIVE_getInstance()))
        e1Wc2 = -e1.windCnt2;
      else
        e1Wc2 = abs(e1.windCnt2);
      tmp$_16 = e2FillType2;
      if (Kotlin.equals(tmp$_16, Clipper$PolyFillType$POSITIVE_getInstance()))
        e2Wc2 = e2.windCnt2;
      else if (Kotlin.equals(tmp$_16, Clipper$PolyFillType$NEGATIVE_getInstance()))
        e2Wc2 = -e2.windCnt2;
      else
      ...
      if (!Kotlin.equals(e1.polyTyp, e2.polyTyp)) {
        ...
        if (Kotlin.equals(tmp$_17, Clipper$ClipType$INTERSECTION_getInstance())) {
          if (e1Wc2 > 0 && e2Wc2 > 0) {
            this.addLocalMinPoly_0(e1, e2, pt);
          }
        }
         else if (Kotlin.equals(tmp$_17, Clipper$ClipType$UNION_getInstance())) {
          if (e1Wc2 <= 0 && e2Wc2 <= 0) {
            this.addLocalMinPoly_0(e1, e2, pt);
          }
        }
         else if (Kotlin.equals(tmp$_17, Clipper$ClipType$DIFFERENCE_getInstance())) {
          if (Kotlin.equals(e1.polyTyp, Clipper$PolyType$CLIP_getInstance()) && e1Wc2 > 0 && e2Wc2 > 0 || (Kotlin.equals(e1.polyTyp, Clipper$PolyType$SUBJECT_getInstance()) && e1Wc2 <= 0 && e2Wc2 <= 0)) {
            this.addLocalMinPoly_0(e1, e2, pt);
          }
        }
         else if (Kotlin.equals(tmp$_17, Clipper$ClipType$XOR_getInstance()))
          this.addLocalMinPoly_0(e1, e2, pt);
      }
       else {
        Edge$Companion_getInstance().swapSides_46mff8$(e1, e2);
  ...
  DefaultClipper.prototype.joinCommonEdges_0 = function () {
    ...
    for (var i = tmp$_0; i <= tmp$_1; i += tmp$_2) {
      ...
      var outRec1 = this.getOutRec_0(((tmp$_3 = join.outPt1) != null ? tmp$_3 : Kotlin.throwNPE()).idx);
      var outRec2 = this.getOutRec_0(((tmp$_4 = join.outPt2) != null ? tmp$_4 : Kotlin.throwNPE()).idx);
      ...
      if (outRec1 === outRec2) {
        ...
        if (this.usingPolyTree_0) {
          ...
          for (var j = 0; j <= tmp$_5; j++) {
            ...
            if (oRec.points == null || ((tmp$_6 = oRec.firstLeft) != null ? tmp$_6 : Kotlin.throwNPE()).parseFirstLeft() !== outRec1 || oRec.isHole === outRec1.isHole) {
              continue;
            }
            tmp$_8 = (tmp$_7 = oRec.points) != null ? tmp$_7 : Kotlin.throwNPE();
            tmp$_10 = (tmp$_9 = join.outPt2) != null ? tmp$_9 : Kotlin.throwNPE();
            if (DefaultClipper$Companion_getInstance().poly2ContainsPoly1_0(tmp$_8, tmp$_10)) {
              oRec.firstLeft = outRec2;
            }
          }
        }
        tmp$_12 = (tmp$_11 = outRec2.points) != null ? tmp$_11 : Kotlin.throwNPE();
        tmp$_14 = (tmp$_13 = outRec1.points) != null ? tmp$_13 : Kotlin.throwNPE();
        if (DefaultClipper$Companion_getInstance().poly2ContainsPoly1_0(tmp$_12, tmp$_14)) {
          ...
          if ((outRec2.isHole ^ this.reverseSolution_0) === outRec2.area() > 0) {
            ((tmp$_15 = outRec2.points) != null ? tmp$_15 : Kotlin.throwNPE()).reversePolyPtLinks();
          }
        }
         else {
          tmp$_17 = (tmp$_16 = outRec1.points) != null ? tmp$_16 : Kotlin.throwNPE();
          tmp$_19 = (tmp$_18 = outRec2.points) != null ? tmp$_18 : Kotlin.throwNPE();
          if (DefaultClipper$Companion_getInstance().poly2ContainsPoly1_0(tmp$_17, tmp$_19)) {
            ...
            if ((outRec1.isHole ^ this.reverseSolution_0) === outRec1.area() > 0) {
              ((tmp$_20 = outRec1.points) != null ? tmp$_20 : Kotlin.throwNPE()).reversePolyPtLinks();
            }
          }
           else {
            outRec2.isHole = outRec1.isHole;
  ...
  DefaultClipper.prototype.popScanbeam_0 = function () {
    var tmp$, tmp$_0;
    var y = ((tmp$ = this.scanbeam_0) != null ? tmp$ : Kotlin.throwNPE()).y;
    this.scanbeam_0 = ((tmp$_0 = this.scanbeam_0) != null ? tmp$_0 : Kotlin.throwNPE()).next;
    return y;
  };
  DefaultClipper.prototype.processEdgesAtTopOfScanbeam_0 = function (topY) {
    ...
    while (e != null) {
      ...
      if (IsMaximaEdge) {
        ...
        if (e.isIntermediate_14dthe$(topY) && ((tmp$ = e.nextInLML) != null ? tmp$ : Kotlin.throwNPE()).isHorizontal) {
          var t = [e];
  ...
  DefaultClipper.prototype.processHorizontal_0 = function (horizontalEdge, isTopOfScanbeam) {
    ...
    var eMaxPair = null;
    while (eLastHorz.nextInLML != null && ((tmp$ = eLastHorz.nextInLML) != null ? tmp$ : Kotlin.throwNPE()).isHorizontal) {
      eLastHorz = (tmp$_0 = eLastHorz.nextInLML) != null ? tmp$_0 : Kotlin.throwNPE();
    }
    ...
    while (true) {
      ...
      while (e != null && (e.current.x !== horzEdge.top.x || horzEdge.nextInLML == null || e.deltaX >= ((tmp$_1 = horzEdge.nextInLML) != null ? tmp$_1 : Kotlin.throwNPE()).deltaX)) {
      ...
      if (horzEdge.nextInLML != null && ((tmp$_2 = horzEdge.nextInLML) != null ? tmp$_2 : Kotlin.throwNPE()).isHorizontal) {
        var t = [horzEdge];
        this.updateEdgeIntoAEL_0(t);
        horzEdge = t[0];
        if (horzEdge.outIdx >= 0) {
  ...
  DefaultClipper.prototype.processIntersectList_0 = function () {
    ...
    for (var i = tmp$_0; i <= tmp$_1; i += tmp$_2) {
      ...
      this.intersectEdges_0((tmp$_3 = iNode.edge1) != null ? tmp$_3 : Kotlin.throwNPE(), (tmp$_4 = iNode.Edge2) != null ? tmp$_4 : Kotlin.throwNPE(), (tmp$_5 = iNode.pt) != null ? tmp$_5 : Kotlin.throwNPE());
      this.swapPositionsInAEL_0((tmp$_6 = iNode.edge1) != null ? tmp$_6 : Kotlin.throwNPE(), (tmp$_7 = iNode.Edge2) != null ? tmp$_7 : Kotlin.throwNPE());
    }
    this.intersectList_0.clear();
  };
  ...
  DefaultClipper.prototype.swapPositionsInAEL_0 = function (edge1, edge2) {
    ...
    if (edge1.nextInAEL === edge2) {
      ...
      if (edge1.nextInAEL != null) {
        ((tmp$ = edge1.nextInAEL) != null ? tmp$ : Kotlin.throwNPE()).prevInAEL = edge1;
      }
      edge1.prevInAEL = edge2.prevInAEL;
      if (edge1.prevInAEL != null) {
        ((tmp$_0 = edge1.prevInAEL) != null ? tmp$_0 : Kotlin.throwNPE()).nextInAEL = edge1;
      }
      edge2.nextInAEL = next_1;
      if (edge2.nextInAEL != null) {
        ((tmp$_1 = edge2.nextInAEL) != null ? tmp$_1 : Kotlin.throwNPE()).prevInAEL = edge2;
      }
      edge2.prevInAEL = prev_1;
      if (edge2.prevInAEL != null) {
        ((tmp$_2 = edge2.prevInAEL) != null ? tmp$_2 : Kotlin.throwNPE()).nextInAEL = edge2;
      }
    }
    if (edge1.prevInAEL == null) {
  ...
  DefaultClipper.prototype.swapPositionsInSEL_0 = function (edge1, edge2) {
    ...
    if (edge1.nextInSEL === edge2) {
      ...
      if (edge1.nextInSEL != null) {
        ((tmp$ = edge1.nextInSEL) != null ? tmp$ : Kotlin.throwNPE()).prevInSEL = edge1;
      }
      edge1.prevInSEL = edge2.prevInSEL;
      if (edge1.prevInSEL != null) {
        ((tmp$_0 = edge1.prevInSEL) != null ? tmp$_0 : Kotlin.throwNPE()).nextInSEL = edge1;
      }
      edge2.nextInSEL = next_1;
      if (edge2.nextInSEL != null) {
        ((tmp$_1 = edge2.nextInSEL) != null ? tmp$_1 : Kotlin.throwNPE()).prevInSEL = edge2;
      }
      edge2.prevInSEL = prev_1;
      if (edge2.prevInSEL != null) {
        ((tmp$_2 = edge2.prevInSEL) != null ? tmp$_2 : Kotlin.throwNPE()).nextInSEL = edge2;
      }
    }
    if (edge1.prevInSEL == null) {
  ...
  DefaultClipper.prototype.updateEdgeIntoAEL_0 = function (eV) {
    ...
    var AelPrev = e.prevInAEL;
    var AelNext = e.nextInAEL;
    ((tmp$ = e.nextInLML) != null ? tmp$ : Kotlin.throwNPE()).outIdx = e.outIdx;
    if (AelPrev != null) {
    ...
    ((tmp$_0 = e.nextInLML) != null ? tmp$_0 : Kotlin.throwNPE()).side = e.side;
    ((tmp$_1 = e.nextInLML) != null ? tmp$_1 : Kotlin.throwNPE()).windDelta = e.windDelta;
    ((tmp$_2 = e.nextInLML) != null ? tmp$_2 : Kotlin.throwNPE()).windCnt = e.windCnt;
    ((tmp$_3 = e.nextInLML) != null ? tmp$_3 : Kotlin.throwNPE()).windCnt2 = e.windCnt2;
    e = (tmp$_4 = e.nextInLML) != null ? tmp$_4 : Kotlin.throwNPE();
    eV[0] = e;
    e.current = Vector2_init_2(e.bot);
    e.prevInAEL = AelPrev;
    e.nextInAEL = AelNext;
  ...
  DefaultClipper.prototype.updateOutPtIdxs_0 = function (outrec) {
    var tmp$, tmp$_0;
    var op = (tmp$ = outrec.points) != null ? tmp$ : Kotlin.throwNPE();
    do {
      op.idx = outrec.Idx;
      op = (tmp$_0 = op.prev) != null ? tmp$_0 : Kotlin.throwNPE();
    }
     while (op !== outrec.points);
  };
  DefaultClipper.prototype.updateWindingCount_0 = function (edge) {
    ...
    while (e != null && (!Kotlin.equals(e.polyTyp, edge.polyTyp) || e.windDelta === 0)) {
      e = e.prevInAEL;
    }
    if (e == null) {
     ...
     else if (edge.windDelta === 0 && !Kotlin.equals(this.clipType_0, Clipper$ClipType$UNION_getInstance())) {
      edge.windCnt = 1;
      edge.windCnt2 = e.windCnt2;
      e = e.nextInAEL;
    }
     else {
      if (edge.isEvenOddFillType_dta898$((tmp$ = this.clipFillType_0) != null ? tmp$ : Kotlin.throwNPE(), (tmp$_0 = this.subjFillType_0) != null ? tmp$_0 : Kotlin.throwNPE())) {
        if (edge.windDelta === 0) {
          var Inside = true;
          var e2 = e.prevInAEL;
          while (e2 != null) {
            if (Kotlin.equals(e2.polyTyp, e.polyTyp) && e2.windDelta !== 0) {
              Inside = !Inside;
            }
            e2 = e2.prevInAEL;
          }
    ...
    if (edge.isEvenOddAltFillType_dta898$((tmp$_1 = this.clipFillType_0) != null ? tmp$_1 : Kotlin.throwNPE(), (tmp$_2 = this.subjFillType_0) != null ? tmp$_2 : Kotlin.throwNPE())) {
      while (e !== edge) {
        if ((e != null ? e : Kotlin.throwNPE()).windDelta !== 0) {
      ...
      while (e !== edge) {
        edge.windCnt2 = edge.windCnt2 + (e != null ? e : Kotlin.throwNPE()).windDelta | 0;
        e = e.nextInAEL;
      }
    }
  };
  ...
  DefaultClipper$Companion.prototype.isParam1RightOfParam2_0 = function (outRec1, outRec2) {
    var outr = outRec1;
    do {
      outr = (outr != null ? outr : Kotlin.throwNPE()).firstLeft;
      if (outr === outRec2) {
        return true;
      }
    }
  ...
  DefaultClipper$Companion.prototype.isPointInPolygon_0 = function (pt, opp) {
    ...
    var poly0y = op.pt.y;
    do {
      op = (tmp$ = op.next) != null ? tmp$ : Kotlin.throwNPE();
      var poly1x = op.pt.x;
      var poly1y = op.pt.y;
      if (poly1y === pty) {
  ...
  DefaultClipper$Companion.prototype.joinHorz_0 = function (op_1, op_1b, op_2, op_2b, Pt, DiscardLeft) {
    ...
    if (Dir1 === Clipper$Direction$LEFT_TO_RIGHT_getInstance()) {
      while (((tmp$ = op1.next) != null ? tmp$ : Kotlin.throwNPE()).pt.x <= Pt.x && ((tmp$_0 = op1.next) != null ? tmp$_0 : Kotlin.throwNPE()).pt.x >= op1.pt.x && ((tmp$_1 = op1.next) != null ? tmp$_1 : Kotlin.throwNPE()).pt.y === Pt.y)
        op1 = (tmp$_2 = op1.next) != null ? tmp$_2 : Kotlin.throwNPE();
      if (DiscardLeft && op1.pt.x !== Pt.x)
        op1 = (tmp$_3 = op1.next) != null ? tmp$_3 : Kotlin.throwNPE();
      ...
      while (((tmp$_5 = op1.next) != null ? tmp$_5 : Kotlin.throwNPE()).pt.x >= Pt.x && ((tmp$_6 = op1.next) != null ? tmp$_6 : Kotlin.throwNPE()).pt.x <= op1.pt.x && ((tmp$_7 = op1.next) != null ? tmp$_7 : Kotlin.throwNPE()).pt.y === Pt.y)
        op1 = (tmp$_8 = op1.next) != null ? tmp$_8 : Kotlin.throwNPE();
      if (!DiscardLeft && op1.pt.x !== Pt.x)
        op1 = (tmp$_9 = op1.next) != null ? tmp$_9 : Kotlin.throwNPE();
      op1b = op1.duplicate_6taknv$(DiscardLeft);
    ...
    if (Dir2 === Clipper$Direction$LEFT_TO_RIGHT_getInstance()) {
      while (((tmp$_11 = op2.next) != null ? tmp$_11 : Kotlin.throwNPE()).pt.x <= Pt.x && ((tmp$_12 = op2.next) != null ? tmp$_12 : Kotlin.throwNPE()).pt.x >= op2.pt.x && ((tmp$_13 = op2.next) != null ? tmp$_13 : Kotlin.throwNPE()).pt.y === Pt.y)
        op2 = (tmp$_14 = op2.next) != null ? tmp$_14 : Kotlin.throwNPE();
      if (DiscardLeft && op2.pt.x !== Pt.x)
        op2 = (tmp$_15 = op2.next) != null ? tmp$_15 : Kotlin.throwNPE();
      ...
      while (((tmp$_17 = op2.next) != null ? tmp$_17 : Kotlin.throwNPE()).pt.x >= Pt.x && ((tmp$_18 = op2.next) != null ? tmp$_18 : Kotlin.throwNPE()).pt.x <= op2.pt.x && ((tmp$_19 = op2.next) != null ? tmp$_19 : Kotlin.throwNPE()).pt.y === Pt.y)
        op2 = (tmp$_20 = op2.next) != null ? tmp$_20 : Kotlin.throwNPE();
      if (!DiscardLeft && op2.pt.x !== Pt.x)
        op2 = (tmp$_21 = op2.next) != null ? tmp$_21 : Kotlin.throwNPE();
      op2b = op2.duplicate_6taknv$(DiscardLeft);
  ...
  DefaultClipper$Companion.prototype.joinPoints_0 = function (j, outRec1, outRec2) {
    ...
    var op1 = (tmp$ = j.outPt1) != null ? tmp$ : Kotlin.throwNPE();
    var op1b;
    var op2 = (tmp$_0 = j.outPt2) != null ? tmp$_0 : Kotlin.throwNPE();
    var op2b;
    var isHorizontal = ((tmp$_1 = j.outPt1) != null ? tmp$_1 : Kotlin.throwNPE()).pt.y === ((tmp$_2 = j.offPt) != null ? tmp$_2 : Kotlin.throwNPE()).y;
    if (isHorizontal && Kotlin.equals(j.offPt, ((tmp$_3 = j.outPt1) != null ? tmp$_3 : Kotlin.throwNPE()).pt) && Kotlin.equals(j.offPt, ((tmp$_4 = j.outPt2) != null ? tmp$_4 : Kotlin.throwNPE()).pt)) {
      if (outRec1 !== outRec2)
        return false;
      op1b = (tmp$_6 = ((tmp$_5 = j.outPt1) != null ? tmp$_5 : Kotlin.throwNPE()).next) != null ? tmp$_6 : Kotlin.throwNPE();
      while (op1b !== op1 && Kotlin.equals(op1b.pt, j.offPt))
        op1b = (tmp$_7 = op1b.next) != null ? tmp$_7 : Kotlin.throwNPE();
      var reverse1 = op1b.pt.y > ((tmp$_8 = j.offPt) != null ? tmp$_8 : Kotlin.throwNPE()).y;
      op2b = (tmp$_10 = ((tmp$_9 = j.outPt2) != null ? tmp$_9 : Kotlin.throwNPE()).next) != null ? tmp$_10 : Kotlin.throwNPE();
      while (op2b !== op2 && Kotlin.equals(op2b.pt, j.offPt))
        op2b = (tmp$_11 = op2b.next) != null ? tmp$_11 : Kotlin.throwNPE();
      var reverse2 = op2b.pt.y > ((tmp$_12 = j.offPt) != null ? tmp$_12 : Kotlin.throwNPE()).y;
      ...
      op1b = op1;
      while (((tmp$_13 = op1.prev) != null ? tmp$_13 : Kotlin.throwNPE()).pt.y === op1.pt.y && op1.prev !== op1b && op1.prev !== op2)
        op1 = (tmp$_14 = op1.prev) != null ? tmp$_14 : Kotlin.throwNPE();
      while (((tmp$_15 = op1b.next) != null ? tmp$_15 : Kotlin.throwNPE()).pt.y === op1b.pt.y && op1b.next !== op1 && op1b.next !== op2)
        op1b = (tmp$_16 = op1b.next) != null ? tmp$_16 : Kotlin.throwNPE();
      if (op1b.next === op1 || op1b.next === op2)
        return false;
      op2b = op2;
      while (((tmp$_17 = op2.prev) != null ? tmp$_17 : Kotlin.throwNPE()).pt.y === op2.pt.y && op2.prev !== op2b && op2.prev !== op1b)
        op2 = (tmp$_18 = op2.prev) != null ? tmp$_18 : Kotlin.throwNPE();
      while (((tmp$_19 = op2b.next) != null ? tmp$_19 : Kotlin.throwNPE()).pt.y === op2b.pt.y && op2b.next !== op2 && op2b.next !== op1)
        op2b = (tmp$_20 = op2b.next) != null ? tmp$_20 : Kotlin.throwNPE();
      ...
      op1b = (tmp$_21 = op1.next) != null ? tmp$_21 : Kotlin.throwNPE();
      while (((tmp$_22 = op1b.pt) != null ? tmp$_22.equals(op1.pt) : null) && op1b !== op1)
        op1b = (tmp$_23 = op1b.next) != null ? tmp$_23 : Kotlin.throwNPE();
      var Reverse1 = !(op1b.pt.y > op1.pt.y) ? !Points_getInstance().slopesEqual_immp3h$(op1.pt, op1b.pt, (tmp$_24 = j.offPt) != null ? tmp$_24 : Kotlin.throwNPE()) : true;
      if (Reverse1) {
        op1b = (tmp$_25 = op1.prev) != null ? tmp$_25 : Kotlin.throwNPE();
        while (((tmp$_26 = op1b.pt) != null ? tmp$_26.equals(op1.pt) : null) && op1b !== op1)
          op1b = (tmp$_27 = op1b.prev) != null ? tmp$_27 : Kotlin.throwNPE();
        if (!(op1b.pt.y > op1.pt.y) ? !Points_getInstance().slopesEqual_immp3h$(op1.pt, op1b.pt, (tmp$_28 = j.offPt) != null ? tmp$_28 : Kotlin.throwNPE()) : true)
          return false;
      }
      op2b = (tmp$_29 = op2.next) != null ? tmp$_29 : Kotlin.throwNPE();
      while (((tmp$_30 = op2b.pt) != null ? tmp$_30.equals(op2.pt) : null) && op2b !== op2)
        op2b = (tmp$_31 = op2b.next) != null ? tmp$_31 : Kotlin.throwNPE();
      var Reverse2 = !(op2b.pt.y > op2.pt.y) ? !Points_getInstance().slopesEqual_immp3h$(op2.pt, op2b.pt, (tmp$_32 = j.offPt) != null ? tmp$_32 : Kotlin.throwNPE()) : true;
      if (Reverse2) {
        op2b = (tmp$_33 = op2.prev) != null ? tmp$_33 : Kotlin.throwNPE();
        while (((tmp$_34 = op2b.pt) != null ? tmp$_34.equals(op2.pt) : null) && op2b !== op2)
          op2b = (tmp$_35 = op2b.prev) != null ? tmp$_35 : Kotlin.throwNPE();
        if (!(op2b.pt.y > op2.pt.y) ? !Points_getInstance().slopesEqual_immp3h$(op2.pt, op2b.pt, (tmp$_36 = j.offPt) != null ? tmp$_36 : Kotlin.throwNPE()) : true)
          return false;
      }
  ...
  function DefaultClipper_init$lambda(node1, node2) {
    var tmp$, tmp$_0;
    var i = ((tmp$ = node2.pt) != null ? tmp$ : Kotlin.throwNPE()).y - ((tmp$_0 = node1.pt) != null ? tmp$_0 : Kotlin.throwNPE()).y;
    if (i > 0) {
      return 1;
    }
     else if (i < 0) {
  ...
  function Edge$Side$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.Edge.Side.' + name);
    }
  }
  ...
  Edge.prototype.findNextLocMin = function () {
    ...
    while (true) {
      while (true) {
        tmp$_1 = e.bot;
        tmp$_0 = ((tmp$ = e.prev) != null ? tmp$ : Kotlin.throwNPE()).bot;
        if (!(!(tmp$_1 != null ? tmp$_1.equals(tmp$_0) : null) || ((tmp$_2 = e.current) != null ? tmp$_2.equals(e.top) : null)))
          break;
        e = (tmp$_3 = e.next) != null ? tmp$_3 : Kotlin.throwNPE();
      }
      if (e.deltaX !== Edge$Companion_getInstance().HORIZONTAL && ((tmp$_4 = e.prev) != null ? tmp$_4 : Kotlin.throwNPE()).deltaX !== Edge$Companion_getInstance().HORIZONTAL)
        break;
      while (((tmp$_5 = e.prev) != null ? tmp$_5 : Kotlin.throwNPE()).deltaX === Edge$Companion_getInstance().HORIZONTAL)
        e = (tmp$_6 = e.prev) != null ? tmp$_6 : Kotlin.throwNPE();
      e2 = e;
      while (e.deltaX === Edge$Companion_getInstance().HORIZONTAL)
        e = (tmp$_7 = e.next) != null ? tmp$_7 : Kotlin.throwNPE();
      if (e.top.y === ((tmp$_8 = e.prev) != null ? tmp$_8 : Kotlin.throwNPE()).bot.y)
        continue;
      if (((tmp$_9 = e2.prev) != null ? tmp$_9 : Kotlin.throwNPE()).bot.x < e.bot.x)
        e = e2;
      break;
    }
    return e;
  ...
  Object.defineProperty(Edge.prototype, 'maximaPair', {
    get: function () {
      var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4;
      var result = null;
      if (((tmp$_0 = ((tmp$ = this.next) != null ? tmp$ : Kotlin.throwNPE()).top) != null ? tmp$_0.equals(this.top) : null) && ((tmp$_1 = this.next) != null ? tmp$_1 : Kotlin.throwNPE()).nextInLML == null) {
        result = this.next;
      }
       else if (((tmp$_3 = ((tmp$_2 = this.prev) != null ? tmp$_2 : Kotlin.throwNPE()).top) != null ? tmp$_3.equals(this.top) : null) && ((tmp$_4 = this.prev) != null ? tmp$_4 : Kotlin.throwNPE()).nextInLML == null) {
        result = this.prev;
      }
  ...
  Edge.prototype.isContributing_xil744$ = function (clipFillType, subjFillType, clipType) {
    ...
    var pft;
    var pft2;
    if (Kotlin.equals(this.polyTyp, Clipper$PolyType$SUBJECT_getInstance())) {
      pft = subjFillType;
      pft2 = clipFillType;
    }
     else {
    ...
    tmp$ = pft;
    if (Kotlin.equals(tmp$, Clipper$PolyFillType$EVEN_ODD_getInstance())) {
      if (this.windDelta === 0 && this.windCnt !== 1)
        return false;
    }
     else if (Kotlin.equals(tmp$, Clipper$PolyFillType$NON_ZERO_getInstance())) {
      if (abs(this.windCnt) !== 1)
        return false;
    }
     else if (Kotlin.equals(tmp$, Clipper$PolyFillType$POSITIVE_getInstance())) {
      if (this.windCnt !== 1)
        return false;
    }
     else if (this.windCnt !== -1)
      return false;
    if (Kotlin.equals(clipType, Clipper$ClipType$INTERSECTION_getInstance())) {
      tmp$_0 = pft2;
      if (Kotlin.equals(tmp$_0, Clipper$PolyFillType$EVEN_ODD_getInstance()) || Kotlin.equals(tmp$_0, Clipper$PolyFillType$NON_ZERO_getInstance()))
        return this.windCnt2 !== 0;
      else if (Kotlin.equals(tmp$_0, Clipper$PolyFillType$POSITIVE_getInstance()))
        return this.windCnt2 > 0;
      else
        return this.windCnt2 < 0;
    }
     else if (Kotlin.equals(clipType, Clipper$ClipType$UNION_getInstance())) {
      tmp$_1 = pft2;
      if (Kotlin.equals(tmp$_1, Clipper$PolyFillType$EVEN_ODD_getInstance()) || Kotlin.equals(tmp$_1, Clipper$PolyFillType$NON_ZERO_getInstance()))
        return this.windCnt2 === 0;
      else if (Kotlin.equals(tmp$_1, Clipper$PolyFillType$POSITIVE_getInstance()))
        return this.windCnt2 <= 0;
      else
        return this.windCnt2 >= 0;
    }
     else if (Kotlin.equals(clipType, Clipper$ClipType$DIFFERENCE_getInstance()))
      if (Kotlin.equals(this.polyTyp, Clipper$PolyType$SUBJECT_getInstance())) {
        tmp$_2 = pft2;
        if (Kotlin.equals(tmp$_2, Clipper$PolyFillType$EVEN_ODD_getInstance()) || Kotlin.equals(tmp$_2, Clipper$PolyFillType$NON_ZERO_getInstance()))
          return this.windCnt2 === 0;
        else if (Kotlin.equals(tmp$_2, Clipper$PolyFillType$POSITIVE_getInstance()))
          return this.windCnt2 <= 0;
        else
          return this.windCnt2 >= 0;
      }
        ...
        tmp$_3 = pft2;
        if (Kotlin.equals(tmp$_3, Clipper$PolyFillType$EVEN_ODD_getInstance()) || Kotlin.equals(tmp$_3, Clipper$PolyFillType$NON_ZERO_getInstance()))
          return this.windCnt2 !== 0;
        else if (Kotlin.equals(tmp$_3, Clipper$PolyFillType$POSITIVE_getInstance()))
          return this.windCnt2 > 0;
        else
          return this.windCnt2 < 0;
      }
     else if (Kotlin.equals(clipType, Clipper$ClipType$XOR_getInstance()))
      if (this.windDelta === 0) {
        tmp$_4 = pft2;
        if (Kotlin.equals(tmp$_4, Clipper$PolyFillType$EVEN_ODD_getInstance()) || Kotlin.equals(tmp$_4, Clipper$PolyFillType$NON_ZERO_getInstance()))
          return this.windCnt2 === 0;
        else if (Kotlin.equals(tmp$_4, Clipper$PolyFillType$POSITIVE_getInstance()))
          return this.windCnt2 <= 0;
        else
          return this.windCnt2 >= 0;
      }
  ...
  Edge.prototype.isEvenOddFillType_dta898$ = function (clipFillType, subjFillType) {
    var type = Kotlin.equals(this.polyTyp, Clipper$PolyType$SUBJECT_getInstance()) ? subjFillType : clipFillType;
  ...
  Edge.prototype.toString = function () {
    return 'TEdge [Bot=' + this.bot + ', Curr=' + this.current + ', Top=' + this.top + ', Delta=' + this.delta + ', Dx=' + this.deltaX + ', PolyTyp=' + Kotlin.toString(this.polyTyp) + ', Side=' + this.side + ', WindDelta=' + this.windDelta + ', WindCnt=' + this.windCnt + ', WindCnt2=' + this.windCnt2 + ', OutIdx=' + this.outIdx + ', Next=' + Kotlin.toString(this.next) + ', Prev=' + Kotlin.toString(this.prev) + ', NextInLML=' + Kotlin.toString(this.nextInLML) + ', NextInAEL=' + Kotlin.toString(this.nextInAEL) + ', PrevInAEL=' + Kotlin.toString(this.prevInAEL) + ', NextInSEL=' + Kotlin.toString(this.nextInSEL) + ', PrevInSEL=' + Kotlin.toString(this.prevInSEL) + ']';
  };
  ...
  Edge$Companion.prototype.topX_pk92ow$ = function (edge, currentY) {
    if (currentY === edge.top.y)
      return edge.top.x;
    return edge.bot.x + round(edge.deltaX * (currentY - edge.bot.y)) | 0;
  };
  ...
  Path$OutPt.prototype.duplicate_6taknv$ = function (InsertAfter) {
    ...
    if (InsertAfter) {
      ...
      result.prev = this;
      ((tmp$ = this.next) != null ? tmp$ : Kotlin.throwNPE()).prev = result;
      this.next = result;
    }
     else {
      result.prev = this.prev;
      result.next = this;
      ((tmp$_0 = this.prev) != null ? tmp$_0 : Kotlin.throwNPE()).next = result;
      this.prev = result;
    }
    return result;
  };
  Object.defineProperty(Path$OutPt.prototype, 'bottomPt', {
    get: function () {
      ...
      if (dups != null) {
        while (dups !== p) {
          if (!Path$OutPt$Companion_getInstance().isFirstBottomPt_0(p, dups != null ? dups : Kotlin.throwNPE())) {
            pp = dups;
          }
          dups = dups.next;
          while (!((tmp$ = (dups != null ? dups : Kotlin.throwNPE()).pt) != null ? tmp$.equals(pp.pt) : null)) {
            dups = dups.next;
          }
        }
      }
  ...
  Object.defineProperty(Path$OutPt.prototype, 'pointCount', {
    get: function () {
      ...
      do {
        result = result + 1 | 0;
        p = (p != null ? p : Kotlin.throwNPE()).next;
      }
       while (p !== this && p != null);
      return result;
    }
  ...
  Path$OutPt.prototype.reversePolyPtLinks = function () {
    ...
    pp1 = this;
    do {
      pp2 = (tmp$ = pp1.next) != null ? tmp$ : Kotlin.throwNPE();
      pp1.next = pp1.prev;
      pp1.prev = pp2;
      pp1 = pp2;
    }
  ...
  Path$OutPt$Companion.prototype.getLowerMostRec_pii0fs$ = function (outRec1, outRec2) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5;
    outRec1.bottomPt = (tmp$_0 = outRec1.bottomPt) != null ? tmp$_0 : ((tmp$ = outRec1.points) != null ? tmp$ : Kotlin.throwNPE()).bottomPt;
    outRec2.bottomPt = (tmp$_2 = outRec2.bottomPt) != null ? tmp$_2 : ((tmp$_1 = outRec2.points) != null ? tmp$_1 : Kotlin.throwNPE()).bottomPt;
    var bPt1 = (tmp$_3 = outRec1.bottomPt) != null ? tmp$_3 : Kotlin.throwNPE();
    var bPt2 = (tmp$_4 = outRec2.bottomPt) != null ? tmp$_4 : Kotlin.throwNPE();
  ...
  Path$OutPt$Companion.prototype.isFirstBottomPt_0 = function (btmPt1, btmPt2) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7, tmp$_8, tmp$_9, tmp$_10;
    var p = (tmp$ = btmPt1.prev) != null ? tmp$ : Kotlin.throwNPE();
    while (((tmp$_0 = p.pt) != null ? tmp$_0.equals(btmPt1.pt) : null) && !Kotlin.equals(p, btmPt1))
      p = (tmp$_1 = p.prev) != null ? tmp$_1 : Kotlin.throwNPE();
    var a = Points_getInstance().getDeltaX_g6xq6k$(btmPt1.pt, p.pt);
    var dx1p = Math_0.abs(a);
    p = (tmp$_2 = btmPt1.next) != null ? tmp$_2 : Kotlin.throwNPE();
    while (((tmp$_3 = p.pt) != null ? tmp$_3.equals(btmPt1.pt) : null) && !Kotlin.equals(p, btmPt1))
      p = (tmp$_4 = p.next) != null ? tmp$_4 : Kotlin.throwNPE();
    var a_0 = Points_getInstance().getDeltaX_g6xq6k$(btmPt1.pt, p.pt);
    var dx1n = Math_0.abs(a_0);
    p = (tmp$_5 = btmPt2.prev) != null ? tmp$_5 : Kotlin.throwNPE();
    while (((tmp$_6 = p.pt) != null ? tmp$_6.equals(btmPt2.pt) : null) && !Kotlin.equals(p, btmPt2))
      p = (tmp$_7 = p.prev) != null ? tmp$_7 : Kotlin.throwNPE();
    var a_1 = Points_getInstance().getDeltaX_g6xq6k$(btmPt2.pt, p.pt);
    var dx2p = Math_0.abs(a_1);
    p = (tmp$_8 = btmPt2.next) != null ? tmp$_8 : Kotlin.throwNPE();
    while (((tmp$_9 = p.pt) != null ? tmp$_9.equals(btmPt2.pt) : null) && Kotlin.equals(p, btmPt2))
      p = (tmp$_10 = p.next) != null ? tmp$_10 : Kotlin.throwNPE();
  ...
  Path$OutRec.prototype.area = function () {
    ...
    var a = 0.0;
    do {
      a = a + (((tmp$_0 = (op != null ? op : Kotlin.throwNPE()).prev) != null ? tmp$_0 : Kotlin.throwNPE()).pt.x + op.pt.x) * (((tmp$_1 = op.prev) != null ? tmp$_1 : Kotlin.throwNPE()).pt.y - op.pt.y);
      op = op.next;
    }
  ...
  Path$OutRec.prototype.fixHoleLinkage = function () {
    var tmp$, tmp$_0;
    if (this.firstLeft == null || (this.isHole !== ((tmp$ = this.firstLeft) != null ? tmp$ : Kotlin.throwNPE()).isHole && ((tmp$_0 = this.firstLeft) != null ? tmp$_0 : Kotlin.throwNPE()).points != null))
      return;
  ...
  Path$OutRec.prototype.parseFirstLeft = function () {
    ...
    while (ret != null && ret.points == null)
      ret = ret.firstLeft;
    return ret != null ? ret : Kotlin.throwNPE();
  };
  ...
  Path.prototype.cleanPolygon_14dthe$ = function (distance) {
    ...
    for (var i_0 = 0; i_0 < tmp$; i_0++) {
      ...
      ((tmp$_0 = outPts[i_0].next) != null ? tmp$_0 : Kotlin.throwNPE()).prev = outPts[i_0];
      outPts[i_0].idx = 0;
    }
    var distSqrd = distance * distance;
    var op = outPts[0];
    while (op.idx === 0 && op.next !== op.prev) {
      if (Points_getInstance().arePointsClose_cnijz2$(op.pt, ((tmp$_1 = op.prev) != null ? tmp$_1 : Kotlin.throwNPE()).pt, distSqrd)) {
        op = Path$Companion_getInstance().excludeOp_0(op);
        cnt = cnt - 1 | 0;
      }
       else {
        if (Points_getInstance().arePointsClose_cnijz2$(((tmp$_2 = op.prev) != null ? tmp$_2 : Kotlin.throwNPE()).pt, ((tmp$_3 = op.next) != null ? tmp$_3 : Kotlin.throwNPE()).pt, distSqrd)) {
          tmp$_5 = (tmp$_4 = op.next) != null ? tmp$_4 : Kotlin.throwNPE();
          Path$Companion_getInstance().excludeOp_0(tmp$_5);
          op = Path$Companion_getInstance().excludeOp_0(op);
          cnt = cnt - 2 | 0;
        }
         else {
          if (Points_getInstance().slopesNearCollinear_mcsb4x$(((tmp$_6 = op.prev) != null ? tmp$_6 : Kotlin.throwNPE()).pt, op.pt, ((tmp$_7 = op.next) != null ? tmp$_7 : Kotlin.throwNPE()).pt, distSqrd)) {
            op = Path$Companion_getInstance().excludeOp_0(op);
            cnt = cnt - 1 | 0;
          }
           else {
            op.idx = 1;
            op = (tmp$_8 = op.next) != null ? tmp$_8 : Kotlin.throwNPE();
          }
        }
      }
    }
    ...
    for (var i_1 = 0; i_1 < tmp$_9; i_1++) {
      ...
      op = (tmp$_10 = op.next) != null ? tmp$_10 : Kotlin.throwNPE();
    }
    return result;
  };
  ...
  Path$Companion.prototype.excludeOp_0 = function (op) {
    var tmp$;
    var result = op.prev;
    (result != null ? result : Kotlin.throwNPE()).next = op.next;
    ((tmp$ = op.next) != null ? tmp$ : Kotlin.throwNPE()).prev = result;
    result.idx = 0;
    return result;
  };
  ...
  Paths.prototype.addPolyNode_s8lpsu$ = function (polynode, nt) {
    var tmp$;
    var match = true;
    if (Kotlin.equals(nt, PolyNode$NodeType$OPEN_getInstance()))
      return;
    else if (Kotlin.equals(nt, PolyNode$NodeType$CLOSED_getInstance()))
  ...
  function PolyNode$NodeType$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant com.soywiz.korma.geom.clipper.PolyNode.NodeType.' + name);
    }
  }
  ...
  Object.defineProperty(PolyNode.prototype, 'next', {
    get: function () {
      var tmp$;
      return !this._childs.isEmpty() ? this._childs.get_za3lpa$(0) : (tmp$ = this.nextSiblingUp_4amfzz$_0) != null ? tmp$ : Kotlin.throwNPE();
    }
  });
  Object.defineProperty(PolyNode.prototype, 'nextSiblingUp_4amfzz$_0', {
    get: function () {
      var tmp$, tmp$_0, tmp$_1;
      return this.parent == null ? null : this.index_g0mmev$_0 === (((tmp$ = this.parent) != null ? tmp$ : Kotlin.throwNPE())._childs.size - 1 | 0) ? ((tmp$_0 = this.parent) != null ? tmp$_0 : Kotlin.throwNPE()).nextSiblingUp_4amfzz$_0 : ((tmp$_1 = this.parent) != null ? tmp$_1 : Kotlin.throwNPE())._childs.get_za3lpa$(this.index_g0mmev$_0 + 1 | 0);
    }
  });
  ...
  Object.defineProperty(Shape2d$Polygon.prototype, 'area', {
    get: function () {
      ...
      new Kotlin.PropertyMetadata('area');
  ...
  function collidesWith($receiver, other) {
    return !Kotlin.equals(clipperOp($receiver, other, Clipper$ClipType$INTERSECTION_getInstance()), Shape2d$Empty_getInstance());
  }
  ...
  function Triangle$Companion$traceList$getPointName(closure$pointsMap) {
    return function (point) {
      return 'p' + Kotlin.toString(closure$pointsMap.get_11rb$(point));
    };
  }
  Triangle$Companion.prototype.traceList_rz78zv$ = function (triangles) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      println_0('  ' + getPointName(point_0) + ' = ' + Kotlin.toString(point_0));
    }
    println_0('Triangles:');
  ...
  PathFind.prototype.find_i4865u$ = function (startNode, endNode) {
    ...
    if (startNode !== null && endNode !== null) {
      ...
      while (!Kotlin.equals(currentNode, endNode) && this.openedListHasItems_0()) {
    ...
    if (!Kotlin.equals(currentNode, endNode))
      throw new PathFindException("Can't find a path", 1);
    while (!Kotlin.equals(currentNode, startNode)) {
      returnList.add_11rb$(currentNode != null ? currentNode : Kotlin.throwNPE());
  ...
  PathFindChannel.prototype.channelToPortals_xmiz5x$ = function (startPoint, endPoint, channel) {
    ...
    if (channel.size >= 2) {
      var firstTriangle = (tmp$ = channel.get_za3lpa$(0).triangle) != null ? tmp$ : Kotlin.throwNPE();
      var secondTriangle = (tmp$_0 = channel.get_za3lpa$(1).triangle) != null ? tmp$_0 : Kotlin.throwNPE();
      var lastTriangle = (tmp$_1 = channel.get_za3lpa$(channel.size - 1 | 0).triangle) != null ? tmp$_1 : Kotlin.throwNPE();
      ...
      for (var n = 0; n < tmp$_2; n++) {
        var triangleCurrent = (tmp$_3 = channel.get_za3lpa$(n + 0 | 0).triangle) != null ? tmp$_3 : Kotlin.throwNPE();
        var triangleNext = (tmp$_4 = channel.get_za3lpa$(n + 1 | 0).triangle) != null ? tmp$_4 : Kotlin.throwNPE();
  ...
  PathFindChannel.prototype.channelToPortals2_tfdvgj$ = function (startPoint, endPoint, channel) {
    ...
    for (var n = 1; n < tmp$_2; n++) {
      var edge = Triangle$Companion_getInstance().getCommonEdge_q9l14g$((tmp$_3 = channel.get_za3lpa$(n - 1 | 0).triangle) != null ? tmp$_3 : Kotlin.throwNPE(), (tmp$_4 = channel.get_za3lpa$(n).triangle) != null ? tmp$_4 : Kotlin.throwNPE());
  ...
  SpatialMesh.prototype.spatialNodeFromPoint_r62tv1$ = function (point) {
    ...
    while (tmp$.hasNext()) {
      var node = tmp$.next();
      if (((tmp$_0 = node.triangle) != null ? tmp$_0 : Kotlin.throwNPE()).pointInsideTriangle_r62tv1$(point))
        return node;
    }
  ...
  SpatialMesh.prototype.getNodeAt_r62tv1$ = function (point) {
    ...
    while (tmp$.hasNext()) {
      var node = tmp$.next();
      if (((tmp$_0 = node.triangle) != null ? tmp$_0 : Kotlin.throwNPE()).containsPoint_r62tv1$(point))
        return node;
    }
    return null;
  };
  SpatialMesh.prototype.getNodeFromTriangle_1ts1sx$ = function (triangle) {
    ...
    if (!this.mapTriangleToSpatialNode_0.containsKey_11rb$(triangle)) {
      ...
      var sn = new SpatialNode((tp[0].x + tp[1].x + tp[2].x) / 3 | 0, (tp[0].y + tp[1].y + tp[2].y) / 3 | 0, 0.0, triangle, 0, 0);
  ...
  SpatialNode.prototype.distanceToSpatialNode_gltg9c$ = function (that) {
    return Math_getInstance().hypot_lu1900$(this.x - that.x, this.y - that.y) | 0;
  };
  ...
  AdvancingFront.prototype.locateNode_14dthe$ = function (x) {
    ...
    if (x < node.value) {
      while (node.prev != null) {
        node = (tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE();
        if (x >= node.value) {
      ...
      while (node.next != null) {
        node = (tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE();
        if (x < node.value) {
          this.search_node = (tmp$_1 = node.prev) != null ? tmp$_1 : Kotlin.throwNPE();
          return (tmp$_2 = node.prev) != null ? tmp$_2 : Kotlin.throwNPE();
        }
      }
    }
    return null;
  ...
  AdvancingFront.prototype.locatePoint_r62tv1$ = function (point) {
    ...
    var px = point.x;
    var node = this.search_node;
    var nx = (node != null ? node : Kotlin.throwNPE()).point.x;
    if (px === nx) {
      if (!(point != null ? point.equals(node.point) : null)) {
        tmp$_0 = ((tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE()).point;
        if (point != null ? point.equals(tmp$_0) : null) {
          node = node.prev;
        }
         else {
          tmp$_2 = ((tmp$_1 = node.next) != null ? tmp$_1 : Kotlin.throwNPE()).point;
  ...
  Sweep.prototype.finalizationPolygon = function () {
    var tmp$, tmp$_0, tmp$_1;
    var next = (tmp$ = this.context_0.front.head.next) != null ? tmp$ : Kotlin.throwNPE();
    var t = (tmp$_0 = next.triangle) != null ? tmp$_0 : Kotlin.throwNPE();
    var p = next.point;
    while (!t.getConstrainedEdgeCW_r62tv1$(p))
      t = (tmp$_1 = t.neighborCCW_r62tv1$(p)) != null ? tmp$_1 : Kotlin.throwNPE();
    this.context_0.meshClean_aetm19$(t);
  };
  Sweep.prototype.pointEvent_r62tv1$ = function (point) {
    var tmp$;
    var node = (tmp$ = this.context_0.locateNode_r62tv1$(point)) != null ? tmp$ : Kotlin.throwNPE();
  ...
  Sweep.prototype.edgeEventByEdge_mxx2yn$ = function (edge, node) {
    ...
    var triangle = (tmp$ = node.triangle) != null ? tmp$ : Kotlin.throwNPE();
  ...
  Sweep.prototype.edgeEventByPoints_dzhhlx$ = function (ep, eq, triangle, point) {
    ...
    if (o2 === Orientation$COLLINEAR_getInstance())
      throw new Error_0('Sweep.edgeEvent: Collinear not supported!');
    if (o1 === o2) {
      this.edgeEventByPoints_dzhhlx$(ep, eq, o1 === Orientation$CW_getInstance() ? (tmp$ = triangle.neighborCCW_r62tv1$(point)) != null ? tmp$ : Kotlin.throwNPE() : (tmp$_0 = triangle.neighborCW_r62tv1$(point)) != null ? tmp$_0 : Kotlin.throwNPE(), point);
    }
     else {
  ...
  Sweep.prototype.newFrontTriangle_qzygyh$ = function (point, node) {
    var tmp$, tmp$_0, tmp$_1;
    var triangle = new Triangle(point, node.point, ((tmp$ = node.next) != null ? tmp$ : Kotlin.throwNPE()).point, this.edgeContext);
    triangle.markNeighborTriangle_4n3hlq$((tmp$_0 = node.triangle) != null ? tmp$_0 : Kotlin.throwNPE());
    this.context_0.addToSet_4n3hlq$(triangle);
    var new_node = new Node(point);
    new_node.next = node.next;
    new_node.prev = node;
    ((tmp$_1 = node.next) != null ? tmp$_1 : Kotlin.throwNPE()).prev = new_node;
    node.next = new_node;
  ...
  Sweep.prototype.fill_mjntug$ = function (node) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5;
    var triangle = new Triangle(((tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE()).point, node.point, ((tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE()).point, this.edgeContext);
    triangle.markNeighborTriangle_4n3hlq$((tmp$_2 = ((tmp$_1 = node.prev) != null ? tmp$_1 : Kotlin.throwNPE()).triangle) != null ? tmp$_2 : Kotlin.throwNPE());
    triangle.markNeighborTriangle_4n3hlq$((tmp$_3 = node.triangle) != null ? tmp$_3 : Kotlin.throwNPE());
    this.context_0.addToSet_4n3hlq$(triangle);
    ((tmp$_4 = node.prev) != null ? tmp$_4 : Kotlin.throwNPE()).next = node.next;
    ((tmp$_5 = node.next) != null ? tmp$_5 : Kotlin.throwNPE()).prev = node.prev;
    if (!this.legalize_4n3hlq$(triangle)) {
      this.context_0.mapTriangleToNodes_4n3hlq$(triangle);
    }
  ...
  Sweep.prototype.fillAdvancingFront_mjntug$ = function (n) {
    ...
    var node;
    var angle;
    node = (tmp$ = n.next) != null ? tmp$ : Kotlin.throwNPE();
    while (node.next != null) {
    ...
    node = (tmp$_1 = n.prev) != null ? tmp$_1 : Kotlin.throwNPE();
    while (node.prev != null) {
      angle = node.holeAngle;
      if (angle > Constants_getInstance().PI_2 || angle < -Constants_getInstance().PI_2)
        break;
      this.fill_mjntug$(node);
      node = (tmp$_2 = node.prev) != null ? tmp$_2 : Kotlin.throwNPE();
    }
    if (n.next != null && ((tmp$_3 = n.next) != null ? tmp$_3 : Kotlin.throwNPE()).next != null) {
      angle = n.basinAngle;
  ...
  Sweep.prototype.fillBasin_mjntug$ = function (node) {
    ...
    basin.left_node = Orientation$Companion_getInstance().orient2d_immp3h$(node.point, ((tmp$ = node.next) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE()).next) != null ? tmp$_1 : Kotlin.throwNPE()).point) === Orientation$CCW_getInstance() ? ((tmp$_2 = node.next) != null ? tmp$_2 : Kotlin.throwNPE()).next : node.next;
    basin.bottom_node = basin.left_node;
    while (((tmp$_3 = basin.bottom_node) != null ? tmp$_3 : Kotlin.throwNPE()).next != null && ((tmp$_4 = basin.bottom_node) != null ? tmp$_4 : Kotlin.throwNPE()).point.y >= ((tmp$_6 = ((tmp$_5 = basin.bottom_node) != null ? tmp$_5 : Kotlin.throwNPE()).next) != null ? tmp$_6 : Kotlin.throwNPE()).point.y) {
      basin.bottom_node = ((tmp$_7 = basin.bottom_node) != null ? tmp$_7 : Kotlin.throwNPE()).next;
    }
    if (Kotlin.equals(basin.bottom_node, basin.left_node))
      return;
    basin.right_node = basin.bottom_node;
    while (((tmp$_8 = basin.right_node) != null ? tmp$_8 : Kotlin.throwNPE()).next != null && ((tmp$_9 = basin.right_node) != null ? tmp$_9 : Kotlin.throwNPE()).point.y < ((tmp$_11 = ((tmp$_10 = basin.right_node) != null ? tmp$_10 : Kotlin.throwNPE()).next) != null ? tmp$_11 : Kotlin.throwNPE()).point.y) {
      basin.right_node = ((tmp$_12 = basin.right_node) != null ? tmp$_12 : Kotlin.throwNPE()).next;
    }
    if (Kotlin.equals(basin.right_node, basin.bottom_node))
      return;
    basin.width = ((tmp$_13 = basin.right_node) != null ? tmp$_13 : Kotlin.throwNPE()).point.x - ((tmp$_14 = basin.left_node) != null ? tmp$_14 : Kotlin.throwNPE()).point.x;
    basin.left_highest = ((tmp$_15 = basin.left_node) != null ? tmp$_15 : Kotlin.throwNPE()).point.y > ((tmp$_16 = basin.right_node) != null ? tmp$_16 : Kotlin.throwNPE()).point.y;
    this.fillBasinReq_mjntug$((tmp$_17 = basin.bottom_node) != null ? tmp$_17 : Kotlin.throwNPE());
  };
  Sweep.prototype.fillBasinReq_mjntug$ = function (node) {
    ...
    if (Kotlin.equals(node_0.prev, this.context_0.basin.left_node) && Kotlin.equals(node_0.next, this.context_0.basin.right_node)) {
      return;
    }
     else if (Kotlin.equals(node_0.prev, this.context_0.basin.left_node)) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(node_0.point, ((tmp$ = node_0.next) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node_0.next) != null ? tmp$_0 : Kotlin.throwNPE()).next) != null ? tmp$_1 : Kotlin.throwNPE()).point) === Orientation$CW_getInstance())
        return;
      node_0 = (tmp$_2 = node_0.next) != null ? tmp$_2 : Kotlin.throwNPE();
    }
     else if (Kotlin.equals(node_0.next, this.context_0.basin.right_node)) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(node_0.point, ((tmp$_3 = node_0.prev) != null ? tmp$_3 : Kotlin.throwNPE()).point, ((tmp$_5 = ((tmp$_4 = node_0.prev) != null ? tmp$_4 : Kotlin.throwNPE()).prev) != null ? tmp$_5 : Kotlin.throwNPE()).point) === Orientation$CCW_getInstance())
        return;
      node_0 = (tmp$_6 = node_0.prev) != null ? tmp$_6 : Kotlin.throwNPE();
    }
     else {
      node_0 = ((tmp$_7 = node_0.prev) != null ? tmp$_7 : Kotlin.throwNPE()).point.y < ((tmp$_8 = node_0.next) != null ? tmp$_8 : Kotlin.throwNPE()).point.y ? (tmp$_9 = node_0.prev) != null ? tmp$_9 : Kotlin.throwNPE() : (tmp$_10 = node_0.next) != null ? tmp$_10 : Kotlin.throwNPE();
    }
  ...
  Sweep.prototype.isShallow_mjntug$ = function (node) {
    ...
    if (this.context_0.basin.left_highest) {
      tmp$_1 = ((tmp$ = this.context_0.basin.left_node) != null ? tmp$ : Kotlin.throwNPE()).point.y - node.point.y;
    }
     else {
      tmp$_1 = ((tmp$_0 = this.context_0.basin.right_node) != null ? tmp$_0 : Kotlin.throwNPE()).point.y - node.point.y;
    }
    var height = tmp$_1;
  ...
  Sweep.prototype.fillRightAboveEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1;
    var node_0 = node;
    while (((tmp$ = node_0.next) != null ? tmp$ : Kotlin.throwNPE()).point.x < edge.p.x) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_0 = node_0.next) != null ? tmp$_0 : Kotlin.throwNPE()).point, edge.p) === Orientation$CCW_getInstance()) {
        this.fillRightBelowEdgeEvent_mxx2yn$(edge, node_0);
      }
       else {
        node_0 = (tmp$_1 = node_0.next) != null ? tmp$_1 : Kotlin.throwNPE();
      }
    }
  };
  Sweep.prototype.fillRightBelowEdgeEvent_mxx2yn$ = function (edge, node) {
    ...
    if (node.point.x >= edge.p.x)
      return;
    if (Orientation$Companion_getInstance().orient2d_immp3h$(node.point, ((tmp$ = node.next) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE()).next) != null ? tmp$_1 : Kotlin.throwNPE()).point) === Orientation$CCW_getInstance()) {
  ...
  Sweep.prototype.fillRightConcaveEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5;
    this.fill_mjntug$((tmp$ = node.next) != null ? tmp$ : Kotlin.throwNPE());
    if (!((tmp$_1 = ((tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE()).point) != null ? tmp$_1.equals(edge.p) : null)) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_2 = node.next) != null ? tmp$_2 : Kotlin.throwNPE()).point, edge.p) === Orientation$CCW_getInstance()) {
        if (Orientation$Companion_getInstance().orient2d_immp3h$(node.point, ((tmp$_3 = node.next) != null ? tmp$_3 : Kotlin.throwNPE()).point, ((tmp$_5 = ((tmp$_4 = node.next) != null ? tmp$_4 : Kotlin.throwNPE()).next) != null ? tmp$_5 : Kotlin.throwNPE()).point) === Orientation$CCW_getInstance()) {
          this.fillRightConcaveEdgeEvent_mxx2yn$(edge, node);
        }
      }
    }
  ...
  Sweep.prototype.fillRightConvexEdgeEvent_mxx2yn$ = function (edge, node) {
    ...
    if (Orientation$Companion_getInstance().orient2d_immp3h$(((tmp$ = node.next) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node.next) != null ? tmp$_0 : Kotlin.throwNPE()).next) != null ? tmp$_1 : Kotlin.throwNPE()).point, ((tmp$_4 = ((tmp$_3 = ((tmp$_2 = node.next) != null ? tmp$_2 : Kotlin.throwNPE()).next) != null ? tmp$_3 : Kotlin.throwNPE()).next) != null ? tmp$_4 : Kotlin.throwNPE()).point) === Orientation$CCW_getInstance()) {
      this.fillRightConcaveEdgeEvent_mxx2yn$(edge, (tmp$_5 = node.next) != null ? tmp$_5 : Kotlin.throwNPE());
    }
     else {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_7 = ((tmp$_6 = node.next) != null ? tmp$_6 : Kotlin.throwNPE()).next) != null ? tmp$_7 : Kotlin.throwNPE()).point, edge.p) === Orientation$CCW_getInstance()) {
        this.fillRightConvexEdgeEvent_mxx2yn$(edge, (tmp$_8 = node.next) != null ? tmp$_8 : Kotlin.throwNPE());
      }
    }
  };
  Sweep.prototype.fillLeftAboveEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1;
    var node_0 = node;
    while (((tmp$ = node_0.prev) != null ? tmp$ : Kotlin.throwNPE()).point.x > edge.p.x) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_0 = node_0.prev) != null ? tmp$_0 : Kotlin.throwNPE()).point, edge.p) === Orientation$CW_getInstance()) {
        this.fillLeftBelowEdgeEvent_mxx2yn$(edge, node_0);
      }
       else {
        node_0 = (tmp$_1 = node_0.prev) != null ? tmp$_1 : Kotlin.throwNPE();
      }
    }
  };
  Sweep.prototype.fillLeftBelowEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1;
    if (node.point.x > edge.p.x) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(node.point, ((tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node.prev) != null ? tmp$_0 : Kotlin.throwNPE()).prev) != null ? tmp$_1 : Kotlin.throwNPE()).point) === Orientation$CW_getInstance()) {
  ...
  Sweep.prototype.fillLeftConvexEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7, tmp$_8;
    if (Orientation$Companion_getInstance().orient2d_immp3h$(((tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE()).point, ((tmp$_1 = ((tmp$_0 = node.prev) != null ? tmp$_0 : Kotlin.throwNPE()).prev) != null ? tmp$_1 : Kotlin.throwNPE()).point, ((tmp$_4 = ((tmp$_3 = ((tmp$_2 = node.prev) != null ? tmp$_2 : Kotlin.throwNPE()).prev) != null ? tmp$_3 : Kotlin.throwNPE()).prev) != null ? tmp$_4 : Kotlin.throwNPE()).point) === Orientation$CW_getInstance()) {
      this.fillLeftConcaveEdgeEvent_mxx2yn$(edge, (tmp$_5 = node.prev) != null ? tmp$_5 : Kotlin.throwNPE());
    }
     else {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_7 = ((tmp$_6 = node.prev) != null ? tmp$_6 : Kotlin.throwNPE()).prev) != null ? tmp$_7 : Kotlin.throwNPE()).point, edge.p) === Orientation$CW_getInstance()) {
        this.fillLeftConvexEdgeEvent_mxx2yn$(edge, (tmp$_8 = node.prev) != null ? tmp$_8 : Kotlin.throwNPE());
      }
    }
  };
  Sweep.prototype.fillLeftConcaveEdgeEvent_mxx2yn$ = function (edge, node) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3, tmp$_4, tmp$_5;
    this.fill_mjntug$((tmp$ = node.prev) != null ? tmp$ : Kotlin.throwNPE());
    if (!((tmp$_1 = ((tmp$_0 = node.prev) != null ? tmp$_0 : Kotlin.throwNPE()).point) != null ? tmp$_1.equals(edge.p) : null)) {
      if (Orientation$Companion_getInstance().orient2d_immp3h$(edge.q, ((tmp$_2 = node.prev) != null ? tmp$_2 : Kotlin.throwNPE()).point, edge.p) === Orientation$CW_getInstance()) {
        if (Orientation$Companion_getInstance().orient2d_immp3h$(node.point, ((tmp$_3 = node.prev) != null ? tmp$_3 : Kotlin.throwNPE()).point, ((tmp$_5 = ((tmp$_4 = node.prev) != null ? tmp$_4 : Kotlin.throwNPE()).prev) != null ? tmp$_5 : Kotlin.throwNPE()).point) === Orientation$CW_getInstance()) {
          this.fillLeftConcaveEdgeEvent_mxx2yn$(edge, node);
        }
      }
    }
  ...
  Sweep.prototype.flipEdgeEvent_dzhhlx$ = function (ep, eq, t, p) {
    ...
    if (Triangle$Companion_getInstance().inScanArea_p5mpkc$(p, t_0.pointCCW_r62tv1$(p), t_0.pointCW_r62tv1$(p), op)) {
      ...
      if ((p != null ? p.equals(eq) : null) && (op != null ? op.equals(ep) : null)) {
        tmp$_1 = ((tmp$_0 = this.context_0.edge_event.constrained_edge) != null ? tmp$_0 : Kotlin.throwNPE()).q;
        if (eq != null ? eq.equals(tmp$_1) : null) {
          tmp$_3 = ((tmp$_2 = this.context_0.edge_event.constrained_edge) != null ? tmp$_2 : Kotlin.throwNPE()).p;
  ...
  Sweep$Companion.prototype.nextFlipPoint_dzhhlx$ = function (ep, eq, ot, op) {
    ...
    if (Kotlin.equals(tmp$, Orientation$CW_getInstance()))
      tmp$_0 = ot.pointCCW_r62tv1$(op);
    else if (Kotlin.equals(tmp$, Orientation$CCW_getInstance()))
  ...
  Object.defineProperty(SweepContext.prototype, 'af_head', {
    get: function () {
      if (this.af_head_yxpno5$_0 == null)
        return Kotlin.throwUPAE('af_head');
  ...
  Object.defineProperty(SweepContext.prototype, 'af_middle', {
    get: function () {
      if (this.af_middle_jdmqww$_0 == null)
        return Kotlin.throwUPAE('af_middle');
  ...
  Object.defineProperty(SweepContext.prototype, 'af_tail', {
    get: function () {
      if (this.af_tail_z48syt$_0 == null)
        return Kotlin.throwUPAE('af_tail');
  ...
  function interpolateAny(min, max, ratio) {
    ...
    if (typeof min === 'number') {
      return (tmp$_1 = interpolate_4(ratio, typeof (tmp$ = min) === 'number' ? tmp$ : Kotlin.throwCCE(), typeof (tmp$_0 = max) === 'number' ? tmp$_0 : Kotlin.throwCCE())) == null || Kotlin.isType(tmp$_1, Any) ? tmp$_1 : Kotlin.throwCCE();
    }
     else if (Kotlin.isType(min, Kotlin.Long)) {
      return (tmp$_4 = interpolate_5(ratio, Kotlin.isType(tmp$_2 = min, Kotlin.Long) ? tmp$_2 : Kotlin.throwCCE(), Kotlin.isType(tmp$_3 = max, Kotlin.Long) ? tmp$_3 : Kotlin.throwCCE())) == null || Kotlin.isType(tmp$_4, Any) ? tmp$_4 : Kotlin.throwCCE();
    }
     else if (typeof min === 'number') {
      return (tmp$_7 = interpolate_2(ratio, typeof (tmp$_5 = min) === 'number' ? tmp$_5 : Kotlin.throwCCE(), typeof (tmp$_6 = max) === 'number' ? tmp$_6 : Kotlin.throwCCE())) == null || Kotlin.isType(tmp$_7, Any) ? tmp$_7 : Kotlin.throwCCE();
    }
     else if (typeof min === 'number') {
      return (tmp$_10 = interpolate_3(ratio, typeof (tmp$_8 = min) === 'number' ? tmp$_8 : Kotlin.throwCCE(), typeof (tmp$_9 = max) === 'number' ? tmp$_9 : Kotlin.throwCCE())) == null || Kotlin.isType(tmp$_10, Any) ? tmp$_10 : Kotlin.throwCCE();
    }
     else if (Kotlin.isType(min, Interpolable)) {
      return (tmp$_13 = (Kotlin.isType(tmp$_11 = min, Interpolable) ? tmp$_11 : Kotlin.throwCCE()).interpolateWith_e37ph5$(Kotlin.isType(tmp$_12 = max, Interpolable) ? tmp$_12 : Kotlin.throwCCE(), ratio)) == null || Kotlin.isType(tmp$_13, Any) ? tmp$_13 : Kotlin.throwCCE();
    }
     else
  ...
  function interpolate_7($receiver, l, r) {
    var tmp$;
    return l.interpolateWith_e37ph5$((tmp$ = r) == null || Kotlin.isType(tmp$, Any) ? tmp$ : Kotlin.throwCCE(), $receiver);
  }
  ...
  Math_1.prototype.interpolate_224j3y$ = function (min, max, ratio) {
    return min + ((max - min | 0) * ratio | 0) | 0;
  };
  ...
  Math_1.prototype.interpolateAny_g28pcy$ = function (min, max, ratio) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    if (typeof min === 'number') {
      tmp$_3 = this.interpolate_224j3y$(min, typeof (tmp$ = max) === 'number' ? tmp$ : Kotlin.throwCCE(), ratio);
    }
     else if (Kotlin.isType(min, Kotlin.Long)) {
      tmp$_3 = this.interpolate_qrehoo$(min, Kotlin.isType(tmp$_0 = max, Kotlin.Long) ? tmp$_0 : Kotlin.throwCCE(), ratio);
    }
     else if (typeof min === 'number') {
      tmp$_3 = this.interpolate_yvo9jy$(min, typeof (tmp$_1 = max) === 'number' ? tmp$_1 : Kotlin.throwCCE(), ratio);
    }
     else if (Kotlin.isType(min, Vector2)) {
      tmp$_3 = min.setToInterpolated_v05y7o$(min, Kotlin.isType(tmp$_2 = max, Vector2) ? tmp$_2 : Kotlin.throwCCE(), ratio);
    }
     else
  ...
  Math_1.prototype.clampf255_14dthe$ = function (v) {
    return v < 0.0 ? 0 : v > 1.0 ? 255 : v * 255 | 0;
  };
  ...
  package$random.MtRand_init_za3lpa$ = MtRand_init;
  package$random.MtRand_init_s8cxhz$ = MtRand_init_0;
